	...
	if ((e && typeof e == "object") || typeof e == "function")
		for (let n of ud(e))
			!fd.call(t, n) &&
				...
				Fo(t, n, {
					get: () => e[n],
					enumerable: !(i = ld(e, n)) || i.enumerable,
				});
	return t;
};
var Pt = (t, e, r) => (
	...
	hd(
		e || !t || !t.__esModule
			? Fo(r, "default", { value: t, enumerable: !0 })
			: r,
		t,
	)
);
var P = v((B) => {
	"use strict";
	var pn = Symbol.for("yaml.alias"),
		Vo = Symbol.for("yaml.document"),
		$r = Symbol.for("yaml.map"),
		qo = Symbol.for("yaml.pair"),
		mn = Symbol.for("yaml.scalar"),
		Or = Symbol.for("yaml.seq"),
		pe = Symbol.for("yaml.node.type"),
		pd = (t) => !!t && typeof t == "object" && t[pe] === pn,
		md = (t) => !!t && typeof t == "object" && t[pe] === Vo,
		vd = (t) => !!t && typeof t == "object" && t[pe] === $r,
		gd = (t) => !!t && typeof t == "object" && t[pe] === qo,
		Wo = (t) => !!t && typeof t == "object" && t[pe] === mn,
		wd = (t) => !!t && typeof t == "object" && t[pe] === Or;
	function zo(t) {
...
var Rt = v((vn) => {
	...
	var H = P(),
		...
		Jo = Symbol("skip children"),
		ne = Symbol("remove node");
	function Hr(t, e) {
		let r = Go(e);
		H.isDocument(t)
			? at(null, t.contents, r, Object.freeze([t])) === ne &&
				(t.contents = null)
			: at(null, t, r, Object.freeze([]));
	}
	Hr.BREAK = q;
	Hr.SKIP = Jo;
	Hr.REMOVE = ne;
	function at(t, e, r, i) {
		let n = Uo(t, e, r, i);
		if (H.isNode(n) || H.isPair(n)) return (Ko(t, i, n), at(t, n, r, i));
		if (typeof n != "symbol") {
			if (H.isCollection(e)) {
				i = Object.freeze(i.concat(e));
				for (let a = 0; a < e.items.length; ++a) {
					let o = at(a, e.items[a], r, i);
					if (typeof o == "number") a = o - 1;
					else {
						if (o === q) return q;
						o === ne && (e.items.splice(a, 1), (a -= 1));
					}
				}
			} else if (H.isPair(e)) {
				i = Object.freeze(i.concat(e));
				let a = at("key", e.key, r, i);
				if (a === q) return q;
				a === ne && (e.key = null);
				let o = at("value", e.value, r, i);
				if (o === q) return q;
				o === ne && (e.value = null);
			}
		}
	...
	async function Dr(t, e) {
		let r = Go(e);
		H.isDocument(t)
			? (await ot(null, t.contents, r, Object.freeze([t]))) === ne &&
				(t.contents = null)
			: await ot(null, t, r, Object.freeze([]));
	}
	Dr.BREAK = q;
	Dr.SKIP = Jo;
	Dr.REMOVE = ne;
	async function ot(t, e, r, i) {
		let n = await Uo(t, e, r, i);
		if (H.isNode(n) || H.isPair(n)) return (Ko(t, i, n), ot(t, n, r, i));
		if (typeof n != "symbol") {
			if (H.isCollection(e)) {
				i = Object.freeze(i.concat(e));
				for (let a = 0; a < e.items.length; ++a) {
					let o = await ot(a, e.items[a], r, i);
					if (typeof o == "number") a = o - 1;
					else {
						if (o === q) return q;
						o === ne && (e.items.splice(a, 1), (a -= 1));
				...
				i = Object.freeze(i.concat(e));
				let a = await ot("key", e.key, r, i);
				if (a === q) return q;
				a === ne && (e.key = null);
				let o = await ot("value", e.value, r, i);
				if (o === q) return q;
				o === ne && (e.value = null);
			}
		}
	...
	function Uo(t, e, r, i) {
		...
		if (H.isMap(e)) return r.Map?.(t, e, i);
		if (H.isSeq(e)) return r.Seq?.(t, e, i);
		if (H.isPair(e)) return r.Pair?.(t, e, i);
		if (H.isScalar(e)) return r.Scalar?.(t, e, i);
		if (H.isAlias(e)) return r.Alias?.(t, e, i);
	}
	function Ko(t, e, r) {
		let i = e[e.length - 1];
		if (H.isCollection(i)) i.items[t] = r;
		else if (H.isPair(i)) t === "key" ? (i.key = r) : (i.value = r);
		else if (H.isDocument(i)) i.contents = r;
		else {
			let n = H.isAlias(i) ? "alias" : "scalar";
		...
		At = class t {
			...
			tagString(e) {
				for (let [r, i] of Object.entries(this.tags))
					if (e.startsWith(i)) return r + Sd(e.substring(i.length));
				return e[0] === "!" ? e : `!<${e}>`;
			}
			toString(e) {
				let r = this.yaml.explicit
					...
					n;
				if (e && i.length > 0 && Yo.isNode(e.contents)) {
					let a = {};
					(bd.visit(e.contents, (o, s) => {
						Yo.isNode(s) && s.tag && (a[s.tag] = !0);
					}),
						(n = Object.keys(a)));
				} else n = [];
				for (let [a, o] of i)
...
`);
	...
	At.defaultYaml = { explicit: !1, version: "1.2" };
			...
			setAnchors: () => {
				for (let a of r) {
					...
					if (
						typeof o == "object" &&
						o.anchor &&
						(Qo.isScalar(o.node) || Qo.isCollection(o.node))
					)
...
var Se = v((is) => {
	...
	var Pd = P();
	function rs(t, e, r) {
		if (Array.isArray(t)) return t.map((i, n) => rs(i, String(n), r));
		if (t && typeof t.toJSON == "function") {
			if (!r || !Pd.hasAnchor(t)) return t.toJSON(e, r);
...
var Br = v((as) => {
	...
	var Rd = wn(),
		...
		yn = class {
			constructor(e) {
				Object.defineProperty(this, ns.NODE_TYPE, { value: e });
			}
			clone() {
				let e = Object.create(
	...
	var _d = Lr(),
		...
		Nn = class extends Td.NodeBase {
			...
			resolve(e, r) {
				...
				r?.aliasResolveCache
					...
					: ((i = []),
						Id.visit(e, {
							Node: (a, o) => {
								(st.isAlias(o) || st.hasAnchor(o)) && i.push(o);
							},
						}),
			...
			toJSON(e, r) {
				...
				let s = i.get(o);
				if ((s || (jd.toJS(o, null, r), (s = i.get(o))), s?.res === void 0)) {
				...
				if (
					a >= 0 &&
					((s.count += 1),
					s.aliasCount === 0 && (s.aliasCount = Mr(n, o, i)),
...
var T = v((bn) => {
	...
	var $d = P(),
		Od = Br(),
		Hd = Se(),
		Dd = (t) => !t || (typeof t != "function" && typeof t != "object"),
		Ee = class extends Od.NodeBase {
			constructor(e) {
				(super($d.SCALAR), (this.value = e));
			}
			toJSON(e, r) {
				return r?.keep ? this.value : Hd.toJS(this.value, e, r);
			}
			toString() {
...
var jt = v((cs) => {
	...
	function Fd(t, e, r) {
		if ((ze.isDocument(t) && (t = t.contents), ze.isNode(t))) return t;
		if (ze.isPair(t)) {
			let u = r.schema[ze.MAP].createNode?.(r.schema, null, r);
		...
		if (i && t && typeof t == "object") {
			if (((c = s.get(t)), c))
				return (c.anchor ?? (c.anchor = n(t)), new Ld.Alias(c.anchor));
			((c = { anchor: null, node: null }), s.set(t, c));
		}
		e?.startsWith("!!") && (e = Bd + e.slice(2));
		let l = Md(t, e, o.tags);
		if (!l) {
			if (
		...
		let f = l?.createNode
			...
			: typeof l?.nodeClass?.from == "function"
				...
				: new ss.Scalar(t);
		return (
			e ? (f.tag = e) : l.default || (f.tag = l.tag), c && (c.node = f), f
		);
	}
	cs.createNode = Fd;
});
var Vr = v((Fr) => {
		...
		Sn = class extends qd.NodeBase {
			...
			clone(e) {
				...
				return (
					...
					(r.items = r.items.map((i) =>
						ae.isNode(i) || ae.isPair(i) ? i.clone(e) : i,
					)),
			...
			addIn(e, r) {
				if (ls(e)) this.add(r);
					...
					let [i, ...n] = e,
						a = this.get(i, !0);
					if (ae.isCollection(a)) a.addIn(n, r);
					else if (a === void 0 && this.schema)
						this.set(i, kn(this.schema, n, r));
					else
						throw new Error(
			...
			deleteIn(e) {
				...
				let n = this.get(r, !0);
				if (ae.isCollection(n)) return n.deleteIn(i);
				throw new Error(
			...
			hasIn(e) {
				...
				let n = this.get(r, !0);
				return ae.isCollection(n) ? n.hasIn(i) : !1;
			}
			setIn(e, r) {
				let [i, ...n] = e;
				if (n.length === 0) this.set(i, r);
					...
					let a = this.get(i, !0);
					if (ae.isCollection(a)) a.setIn(n, r);
					else if (a === void 0 && this.schema)
						this.set(i, kn(this.schema, n, r));
					else
						throw new Error(
	...
	Fr.Collection = Sn;
	Fr.collectionFromPath = kn;
	Fr.isEmptyPath = ls;
});
var $t = v((qr) => {
	"use strict";
	var Wd = (t) => t.replace(/^(?!$)(?: $)?/gm, "#");
	function En(t, e) {
		return /^\n+$/.test(t)
			? t.substring(1)
			: e
...
var ds = v((Ot) => {
	...
	function Gd(
		...
		let d,
			...
			p = -1,
			y = -1;
		r === xn && ((h = us(t, h, e.length)), h !== -1 && (u = h + c));
		for (let k; (k = t[(h += 1)]);) {
			if (r === Wr && k === "\\") {
				switch (((p = h), t[h + 1])) {
					case "x":
...
`),
		...
		return (
			(o = s ? o + r.slice(s) : r),
			i ? o : xe.foldFlowLines(o, a, xe.FOLD_QUOTED, Jr(e, !1))
		);
	}
	function Cn(t, e) {
		if (
...
${r}`,
				...
				"'";
		return e.implicitKey ? i : xe.foldFlowLines(i, r, xe.FOLD_FLOW, Jr(e, !1));
	}
	function ct(t, e) {
...
|$)`,
	...
	function zr({ comment: t, type: e, value: r }, i, n, a) {
		let { blockQuote: o, commentString: s, lineWidth: c } = i.options;
		if (!o || /\n[\t ]+$/.test(r)) return ct(r, i);
		let l = i.indent || (i.forceBlockIndent || Gr(r) ? "  " : ""),
			f =
				o === "literal"
					? !0
					: o === "folded" || e === Q.Scalar.BLOCK_FOLDED
						? !1
						: e === Q.Scalar.BLOCK_LITERAL
							? !0
							: !Ud(r, c, l.length);
		if (!r)
			return f
...
$&`,
				...
				A = Jr(i, !0);
			o !== "folded" &&
				e !== Q.Scalar.BLOCK_FOLDED &&
				(A.onOverflow = () => {
					x = !0;
				});
			let N = xe.foldFlowLines(`${b}${E}${m}`, l, xe.FOLD_BLOCK, A);
			if (!x)
				return `>${S}
${l}${N}`;
		}
...
`)
			...
			return zr(t, e, r, i);
		if (Gr(a)) {
			if (c === "") return ((e.forceBlockIndent = !0), zr(t, e, r, i));
			if (s && c === l) return ct(a, e);
		}
		let u = a.replace(
			/\n+/g,
			`$&
${c}`,
		...
		if (o) {
			...
			if (g.some(d) || m?.some(d)) return ct(a, e);
		}
		return s ? u : xe.foldFlowLines(u, c, xe.FOLD_FLOW, Jr(e, !1));
	}
	function Yd(t, e, r, i) {
		let { implicitKey: n, inFlow: a } = e,
			...
			{ type: s } = t;
		s !== Q.Scalar.QUOTE_DOUBLE &&
			/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o.value) &&
			(s = Q.Scalar.QUOTE_DOUBLE);
		let c = (f) => {
				switch (f) {
					case Q.Scalar.BLOCK_FOLDED:
					case Q.Scalar.BLOCK_LITERAL:
						return n || a ? ct(o.value, e) : zr(o, e, r, i);
					case Q.Scalar.QUOTE_DOUBLE:
						return Ht(o.value, e);
					case Q.Scalar.QUOTE_SINGLE:
						return Cn(o.value, e);
					case Q.Scalar.PLAIN:
						return Kd(o, e, r, i);
					default:
...
var Lt = v((Rn) => {
	...
	function ef(t, e) {
		let r = Object.assign(
				{
					blockQuote: !0,
					commentString: Qd.stringifyComment,
					defaultKeyType: null,
	...
	function rf(t, e, { anchors: r, doc: i }) {
		if (!i.directives) return "";
		let n = [],
			a = (Ce.isScalar(t) || Ce.isCollection(t)) && t.anchor;
		a && Xd.anchorIsValid(a) && (r.add(a), n.push(`&${a}`));
		let o = t.tag ?? (e.default ? null : e.tag);
		return (o && n.push(i.directives.tagString(o)), n.join(" "));
	}
	function nf(t, e, r, i) {
		if (Ce.isPair(t)) return t.toString(e, r, i);
		if (Ce.isAlias(t)) {
		...
		let n,
			a = Ce.isNode(t) ? t : e.doc.createNode(t, { onTagObj: (c) => (n = c) });
		n ?? (n = tf(e.doc.schema.tags, a));
		let o = rf(a, n, e);
		...
		let s =
			typeof n.stringify == "function"
				? n.stringify(a, e, r, i)
				: Ce.isScalar(a)
					? Zd.stringifyString(a, e, r, i)
					: a.toString(e, r, i);
		return o
			? Ce.isScalar(a) || s[0] === "{" || s[0] === "["
				? `${o} ${s}`
				: `${o}
${e.indent}${s}`
			: s;
	}
	Rn.createStringifyContext = ef;
	Rn.stringify = nf;
});
var vs = v((ms) => {
	"use strict";
	var me = P(),
		...
		ps = Lt(),
		Bt = $t();
	function af({ key: t, value: e }, r, i, n) {
		let {
				allNullValues: a,
				doc: o,
				indent: s,
			...
			d = (me.isNode(t) && t.comment) || null;
		if (u) {
			if (d)
				throw new Error("With simple keys, key nodes cannot have comments");
			if (me.isCollection(t) || (!me.isNode(t) && typeof t == "object")) {
		...
		let m =
			...
			(!t ||
				...
				me.isCollection(t) ||
				(me.isScalar(t)
					? t.type === hs.Scalar.BLOCK_FOLDED ||
						t.type === hs.Scalar.BLOCK_LITERAL
					: typeof t == "object"));
		r = Object.assign({}, r, {
			allNullValues: !1,
			implicitKey: !m && (u || !a),
		...
		if (r.inFlow) {
			if (a || e == null)
				return (g && i && i(), p === "" ? "?" : m ? `? ${p}` : p);
		} else if ((a && !u) || (e == null && m))
			return (
				(p = `? ${p}`),
				d && !g ? (p += Bt.lineComment(p, r.indent, l(d))) : h && n && n(),
				p
			);
		(g && (d = null),
			m
				? (d && (p += Bt.lineComment(p, r.indent, l(d))),
					(p = `? ${p}
${s}:`))
				: ((p = `${p}:`), d && (p += Bt.lineComment(p, r.indent, l(d)))));
		let y, b, k;
		(me.isNode(e)
			...
			(r.implicitKey = !1),
			!m && !d && me.isScalar(e) && (r.indentAtStart = p.length + 1),
			(h = !1),
			!f &&
				c.length >= 2 &&
				!r.inFlow &&
...
`)
				: (x += `
${r.indent}`);
		} else if (!m && me.isCollection(e)) {
			let A = E[0],
				N = E.indexOf(`
`),
				$ = N !== -1,
				ke = r.inFlow ?? e.flow ?? e.items.length === 0;
			if ($ || !ke) {
				let nt = !1;
				if ($ && (A === "&" || A === "!")) {
					let O = E.indexOf(" ");
...
`) &&
		...
		return (
			...
			r.inFlow
				? S && i && i()
				: k && !S
					? (p += Bt.lineComment(p, r.indent, l(k)))
					: h && n && n(),
			p
		);
	}
...
var _n = v((An) => {
	...
	function sf(t, e) {
		(t === "debug" || t === "warn") &&
			(typeof gs.emitWarning == "function"
				? gs.emitWarning(e)
				: console.warn(e));
	}
	An.debug = of;
...
var Qr = v((Xr) => {
	...
	var Yr = P(),
		...
		Kr = {
			identify: (t) =>
				t === Ur || (typeof t == "symbol" && t.description === Ur),
			default: "key",
			tag: "tag:yaml.org,2002:merge",
			test: /^<<$/,
			resolve: () =>
				Object.assign(new ws.Scalar(Symbol(Ur)), { addToJSMap: ys }),
			stringify: () => Ur,
		},
		cf = (t, e) =>
			(Kr.identify(e) ||
				(Yr.isScalar(e) &&
					(!e.type || e.type === ws.Scalar.PLAIN) &&
					Kr.identify(e.value))) &&
			t?.doc.schema.tags.some((r) => r.tag === Kr.tag && r.default);
	function ys(t, e, r) {
		let i = Ns(t, r);
		if (Yr.isSeq(i)) for (let n of i.items) In(t, e, n);
		else if (Array.isArray(i)) for (let n of i) In(t, e, n);
		else In(t, e, i);
	}
	function In(t, e, r) {
		let i = Ns(t, r);
	...
	function Ns(t, e) {
		return t && Yr.isAlias(e) ? e.resolve(t.doc, t) : e;
	}
	Xr.addMergeToJSMap = ys;
	Xr.isMergeKey = cf;
	Xr.merge = Kr;
});
var jn = v((Ss) => {
	...
	var lf = _n(),
		...
		ks = P(),
		Tn = Se();
	function df(t, e, { key: r, value: i }) {
		if (ks.isNode(r) && r.addToJSMap) r.addToJSMap(t, e, i);
		else if (bs.isMergeKey(t, r)) bs.addMergeToJSMap(t, e, i);
		else {
			let n = Tn.toJS(r, "", t);
			if (e instanceof Map) e.set(n, Tn.toJS(i, n, t));
	...
	function ff(t, e, r) {
		...
		if (ks.isNode(t) && r?.doc) {
			let i = uf.createStringifyContext(r.doc, {});
			i.anchors = new Set();
...
var Pe = v(($n) => {
	...
	var Es = jt(),
		...
		Zr = P();
	function mf(t, e, r) {
		let i = Es.createNode(t, void 0, r),
			n = Es.createNode(e, void 0, r);
		return new ei(i, n);
	}
	var ei = class t {
		constructor(e, r = null) {
			(Object.defineProperty(this, Zr.NODE_TYPE, { value: Zr.PAIR }),
				(this.key = e),
				(this.value = r));
		}
		clone(e) {
			...
			return (
				Zr.isNode(r) && (r = r.clone(e)),
				Zr.isNode(i) && (i = i.clone(e)),
				new t(r, i)
			);
		}
		toJSON(e, r) {
			let i = r?.mapAsMap ? new Map() : {};
			return pf.addPairToJSMap(r, i, this);
		}
		toString(e, r, i) {
			return e?.doc ? hf.stringifyPair(this, e, r, i) : JSON.stringify(this);
		}
	};
	$n.Pair = ei;
	$n.createPair = mf;
...
var On = v((Cs) => {
	...
	var Je = P(),
		...
		ti = $t();
	function vf(t, e, r) {
		return ((e.inFlow ?? t.flow) ? wf : gf)(t, e, r);
	}
	function gf(
		{ comment: t, items: e },
		r,
		...
		for (let g = 0; g < e.length; ++g) {
			let h = e[g],
				p = null;
			if (Je.isNode(h))
				(!u && h.spaceBefore && d.push(""),
					ri(r, d, h.commentBefore, u),
					h.comment && (p = h.comment));
			else if (Je.isPair(h)) {
				let b = Je.isNode(h.key) ? h.key : null;
				b && (!u && b.spaceBefore && d.push(""), ri(r, d, b.commentBefore, u));
			}
			u = !1;
			let y = xs.stringify(
				h,
			...
			(p && (y += ti.lineComment(y, a, l(p))),
				u && p && (u = !1),
				d.push(i + y));
		}
		let m;
		if (d.length === 0) m = n.start + n.end;
		else {
			m = d[0];
...
`;
		...
		return (
			t
				? ((m +=
						`
` + ti.indentComment(l(t), c)),
					s && s())
				: u && o && o(),
			m
		);
	}
	function wf({ items: t }, e, { flowChars: r, itemIndent: i }) {
		let {
			indent: n,
			indentStep: a,
		...
		for (let g = 0; g < t.length; ++g) {
			...
			if (Je.isNode(h))
				(h.spaceBefore && u.push(""),
					ri(e, u, h.commentBefore, !1),
					h.comment && (p = h.comment));
			else if (Je.isPair(h)) {
				let b = Je.isNode(h.key) ? h.key : null;
				b &&
					(b.spaceBefore && u.push(""),
					ri(e, u, b.commentBefore, !1),
					b.comment && (l = !0));
				let k = Je.isNode(h.value) ? h.value : null;
				k
					? (k.comment && (p = k.comment), k.commentBefore && (l = !0))
					: h.value == null && b?.comment && (p = b.comment);
			}
			p && (l = !0);
			let y = xs.stringify(h, c, () => (p = null));
			(l ||
				(l =
					u.length > f ||
					y.includes(`
				...
				g < t.length - 1
					...
					: e.options.trailingComma &&
						(e.options.lineWidth > 0 &&
							(l ||
								(l =
									u.reduce((b, k) => b + k.length + 2, 2) + (y.length + 2) >
									e.options.lineWidth)),
						l && (y += ",")),
				p && (y += ti.lineComment(y, i, s(p))),
				u.push(y),
				(f = u.length));
		}
		let { start: d, end: m } = r;
		if (u.length === 0) return d + m;
		if (!l) {
			let g = u.reduce((h, p) => h + p.length + 2, 2);
...
`;
			return `${g}
${n}${m}`;
		} else return `${d}${o}${u.join(" ")}${o}${m}`;
	}
	function ri({ indent: t, options: { commentString: e } }, r, i, n) {
		if ((i && n && (i = i.replace(/^\n+/, "")), i)) {
			let a = ti.indentComment(e(i), t);
			r.push(a.trimStart());
		}
	}
	Cs.stringifyCollection = vf;
});
var Ae = v((Dn) => {
	"use strict";
	var yf = On(),
		...
		kf = T();
	function Mt(t, e) {
		let r = Re.isScalar(e) ? e.value : e;
		for (let i of t)
			if (
				Re.isPair(i) &&
				(i.key === e ||
					i.key === r ||
					(Re.isScalar(i.key) && i.key.value === r))
			)
				return i;
	}
	var Hn = class extends bf.Collection {
		static get tagName() {
			return "tag:yaml.org,2002:map";
		}
		constructor(e) {
			(super(Re.MAP, e), (this.items = []));
		}
		static from(e, r, i) {
			let { keepUndefined: n, replacer: a } = i,
				...
				s = (c, l) => {
					...
					(l !== void 0 || n) && o.items.push(ii.createPair(c, l, i));
				};
		...
		add(e, r) {
			...
			Re.isPair(e)
				...
				: !e || typeof e != "object" || !("key" in e)
					? (i = new ii.Pair(e, e?.value))
					: (i = new ii.Pair(e.key, e.value));
			let n = Mt(this.items, i.key),
				a = this.schema?.sortMapEntries;
			if (n) {
				if (!r) throw new Error(`Key ${i.key} already set`);
				Re.isScalar(n.value) && kf.isScalarValue(i.value)
...
var lt = v((Rs) => {
	...
	var Sf = P(),
		...
		Ef = {
			collection: "map",
			default: !0,
			nodeClass: Ps.YAMLMap,
			tag: "tag:yaml.org,2002:map",
			resolve(t, e) {
				return (Sf.isMap(t) || e("Expected a mapping for this tag"), t);
			},
			createNode: (t, e, r) => Ps.YAMLMap.from(t, e, r),
		};
	Rs.map = Ef;
});
var _e = v((As) => {
	...
	var xf = jt(),
		...
		Rf = T(),
		Af = Se(),
		Ln = class extends Pf.Collection {
			static get tagName() {
				return "tag:yaml.org,2002:seq";
			}
			constructor(e) {
				(super(ai.SEQ, e), (this.items = []));
			}
			add(e) {
				this.items.push(e);
			}
			...
			get(e, r) {
				...
				let n = this.items[i];
				return !r && ai.isScalar(n) ? n.value : n;
			}
			has(e) {
				let r = ni(e);
			...
			set(e, r) {
				...
				let n = this.items[i];
				ai.isScalar(n) && Rf.isScalarValue(r)
					? (n.value = r)
					: (this.items[i] = r);
			}
			toJSON(e, r) {
				...
				let n = 0;
				for (let a of this.items) i.push(Af.toJS(a, String(n++), r));
				return i;
			}
			toString(e, r, i) {
				return e
					? Cf.stringifyCollection(this, e, {
							blockItemPrefix: "- ",
							flowChars: { start: "[", end: "]" },
							itemIndent: (e.indent || "") + "  ",
							onChompKeep: i,
			...
			static from(e, r, i) {
				...
				if (r && Symbol.iterator in Object(r)) {
					...
					for (let s of r) {
						...
						a.items.push(xf.createNode(s, void 0, i));
					}
				}
				return a;
			}
...
var ut = v((Is) => {
	...
	var _f = P(),
		...
		If = {
			collection: "seq",
			default: !0,
			nodeClass: _s.YAMLSeq,
			tag: "tag:yaml.org,2002:seq",
			resolve(t, e) {
				return (_f.isSeq(t) || e("Expected a sequence for this tag"), t);
			},
			createNode: (t, e, r) => _s.YAMLSeq.from(t, e, r),
		};
	Is.seq = If;
});
var Ft = v((Ts) => {
...
var oi = v((Os) => {
	...
	var js = T(),
		$s = {
			identify: (t) => t == null,
			createNode: () => new js.Scalar(null),
			default: !0,
			tag: "tag:yaml.org,2002:null",
			test: /^(?:~|[Nn]ull|NULL)?$/,
			resolve: () => new js.Scalar(null),
			stringify: ({ source: t }, e) =>
				typeof t == "string" && $s.test.test(t) ? t : e.options.nullStr,
		};
	Os.nullTag = $s;
});
var Bn = v((Ds) => {
	...
	var $f = T(),
		Hs = {
			...
			resolve: (t) => new $f.Scalar(t[0] === "t" || t[0] === "T"),
...
var dt = v((Ls) => {
	"use strict";
	function Of({ format: t, minFractionDigits: e, tag: r, value: i }) {
	...
	var Hf = T(),
		...
		Lf = {
			...
			stringify(t) {
				...
				return isFinite(e) ? e.toExponential() : Mn.stringifyNumber(t);
			},
		},
		Bf = {
			identify: (t) => typeof t == "number",
			...
			test: /^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,
			resolve(t) {
				let e = new Hf.Scalar(parseFloat(t)),
					r = t.indexOf(".");
				return (
					r !== -1 &&
						t[t.length - 1] === "0" &&
...
var qn = v((li) => {
	"use strict";
	var Bs = dt(),
		ci = (t) => typeof t == "bigint" || Number.isInteger(t),
		Vn = (t, e, r, { intAsBigInt: i }) =>
			i ? BigInt(t) : parseInt(t.substring(e), r);
	function Ms(t, e, r) {
		let { value: i } = t;
		return ci(i) && i >= 0 ? r + i.toString(e) : Bs.stringifyNumber(t);
	}
	var Mf = {
			identify: (t) => ci(t) && t >= 0,
			default: !0,
			...
			format: "OCT",
			test: /^0o[0-7]+$/,
			resolve: (t, e, r) => Vn(t, 2, 8, r),
			stringify: (t) => Ms(t, 8, "0o"),
		},
		Ff = {
			identify: ci,
			default: !0,
			tag: "tag:yaml.org,2002:int",
			test: /^[-+]?[0-9]+$/,
			resolve: (t, e, r) => Vn(t, 0, 10, r),
			stringify: Bs.stringifyNumber,
		},
		Vf = {
			identify: (t) => ci(t) && t >= 0,
			default: !0,
			...
			format: "HEX",
			test: /^0x[0-9a-fA-F]+$/,
			resolve: (t, e, r) => Vn(t, 2, 16, r),
			stringify: (t) => Ms(t, 16, "0x"),
		};
	li.int = Ff;
	li.intHex = Vf;
	li.intOct = Mf;
...
var zs = v((Ws) => {
	...
	var ui = ({ value: t }) => JSON.stringify(t),
		Qf = [
			{
				identify: (t) => typeof t == "string",
				default: !0,
			...
			},
			{
				...
				stringify: ({ value: t }) => (qs(t) ? t.toString() : JSON.stringify(t)),
			},
			{
				identify: (t) => typeof t == "number",
				default: !0,
...
var Gn = v((Js) => {
	...
	var Vt = jr("buffer"),
		...
		rh = {
			...
			resolve(t, e) {
				if (typeof Vt.Buffer == "function") return Vt.Buffer.from(t, "base64");
			...
			stringify({ comment: t, type: e, value: r }, i, n, a) {
				...
				let o = r,
					s;
				if (typeof Vt.Buffer == "function")
					s =
						o instanceof Vt.Buffer
							? o.toString("base64")
							: Vt.Buffer.from(o.buffer).toString("base64");
				...
				if (
					(e ?? (e = Jn.Scalar.BLOCK_LITERAL), e !== Jn.Scalar.QUOTE_DOUBLE)
				) {
					let c = Math.max(
					...
					s = f.join(
						e === Jn.Scalar.BLOCK_LITERAL
							? `
`
							: " ",
					);
				}
				return th.stringifyString({ comment: t, type: e, value: s }, i, n, a);
			},
		};
	Js.binary = rh;
});
			...
			for (let r = 0; r < t.items.length; ++r) {
				...
				if (!di.isPair(i)) {
					if (di.isMap(i)) {
						...
						let n = i.items[0] || new Un.Pair(new ih.Scalar(null));
						if (
							(i.commentBefore &&
...
${a.comment}`
					...
					t.items[r] = di.isPair(i) ? i : new Un.Pair(i);
				}
			}
	...
	function Us(t, e, r) {
		...
		if (e && Symbol.iterator in Object(e))
			for (let o of e) {
				...
				n.items.push(Un.createPair(s, c, r));
			}
		return n;
	}
	var ah = {
...
var Xn = v((Yn) => {
	...
	var Ks = P(),
		...
		oh = _e(),
		Ys = hi(),
		Ge = class t extends oh.YAMLSeq {
			constructor() {
				(super(),
					(this.add = qt.YAMLMap.prototype.add.bind(this)),
					(this.delete = qt.YAMLMap.prototype.delete.bind(this)),
					(this.get = qt.YAMLMap.prototype.get.bind(this)),
					(this.has = qt.YAMLMap.prototype.has.bind(this)),
					(this.set = qt.YAMLMap.prototype.set.bind(this)),
					(this.tag = t.tag));
			}
			toJSON(e, r) {
				...
				for (let n of this.items) {
					...
					if (
						(Ks.isPair(n)
							? ((a = Kn.toJS(n.key, "", r)), (o = Kn.toJS(n.value, a, r)))
							: (a = Kn.toJS(n, "", r)),
						i.has(a))
					)
			...
			static from(e, r, i) {
				let n = Ys.createPairs(e, r, i),
					a = new this();
				return ((a.items = n.items), a);
			}
		};
	Ge.tag = "tag:yaml.org,2002:omap";
	var sh = {
		collection: "seq",
			...
			for (let { key: n } of r.items)
				Ks.isScalar(n) &&
					(i.includes(n.value)
						...
						: i.push(n.value));
			return Object.assign(new Ge(), r);
		},
		createNode: (t, e, r) => Ge.from(t, e, r),
	};
	Yn.YAMLOMap = Ge;
	Yn.omap = sh;
});
var tc = v((Qn) => {
	"use strict";
	var Xs = T();
	function Qs({ value: t, source: e }, r) {
		return e && (t ? Zs : ec).test.test(e)
			? e
			: t
				? r.options.trueStr
				: r.options.falseStr;
...
var rc = v((pi) => {
	...
	var ch = T(),
		...
		uh = {
			...
			stringify(t) {
				let e = Number(t.value);
				return isFinite(e) ? e.toExponential() : Zn.stringifyNumber(t);
			},
		},
		dh = {
			identify: (t) => typeof t == "number",
			...
			test: /^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,
			resolve(t) {
				let e = new ch.Scalar(parseFloat(t.replace(/_/g, ""))),
					r = t.indexOf(".");
				if (r !== -1) {
...
var nc = v((zt) => {
	"use strict";
	var ic = dt(),
		Wt = (t) => typeof t == "bigint" || Number.isInteger(t);
	function mi(t, e, r, { intAsBigInt: i }) {
		let n = t[0];
		if (
			((n === "-" || n === "+") && (e += 1),
	...
	var fh = {
		...
		ph = {
			...
			tag: "tag:yaml.org,2002:int",
			test: /^[-+]?[0-9][0-9_]*$/,
			resolve: (t, e, r) => mi(t, 0, 10, r),
			stringify: ic.stringifyNumber,
		},
		mh = {
			identify: Wt,
			default: !0,
...
var ra = v((ta) => {
		...
		Ue = class t extends gi.YAMLMap {
			...
			add(e) {
				...
				(wi.isPair(e)
					...
					: e &&
						  ...
						  "value" in e &&
						  e.value === null
						? (r = new vi.Pair(e.key, null))
						: (r = new vi.Pair(e, null)),
					gi.findPair(this.items, r.key) || this.items.push(r));
			}
			get(e, r) {
				let i = gi.findPair(this.items, e);
				return !r && wi.isPair(i)
					? wi.isScalar(i.key)
						? i.key.value
						: i.key
					: i;
			...
			set(e, r) {
				...
				i && !r
					...
					: !i && r && this.items.push(new vi.Pair(e));
			}
			toJSON(e, r) {
				...
				if (r && Symbol.iterator in Object(r))
					for (let o of r)
						(typeof n == "function" && (o = n.call(r, o, o)),
							a.items.push(vi.createPair(o, null, i)));
				return a;
			}
		};
	...
	var vh = {
		...
		createNode: (t, e, r) => Ue.from(t, e, r),
		resolve(t, e) {
			if (wi.isMap(t)) {
...
var na = v((yi) => {
	...
	function ac(t) {
		...
		else if (isNaN(e) || !isFinite(e)) return gh.stringifyNumber(t);
		let i = "";
		e < 0 && ((i = "-"), (e *= r(-1)));
		let n = r(60),
			a = [e % n];
	...
	var wh = {
			...
			resolve: (t, e, { intAsBigInt: r }) => ia(t, r),
			stringify: ac,
		},
		yh = {
			identify: (t) => typeof t == "number",
...
var yc = v((la) => {
	...
	var hc = lt(),
		...
		dc = new Map([
			["core", jh.schema],
			["failsafe", [hc.map, pc.seq, Ih.string]],
			["json", $h.schema],
			["yaml11", uc.schema],
			["yaml-1.1", uc.schema],
		]),
		fc = {
			...
			bool: Th.boolTag,
			float: sa.float,
			floatExp: sa.floatExp,
			floatNaN: sa.floatNaN,
			floatTime: bi.floatTime,
			int: ca.int,
			intHex: ca.intHex,
			intOct: ca.intOct,
			intTime: bi.intTime,
		...
		Oh = {
			"tag:yaml.org,2002:binary": mc.binary,
			"tag:yaml.org,2002:merge": Jt.merge,
			"tag:yaml.org,2002:omap": vc.omap,
			"tag:yaml.org,2002:pairs": gc.pairs,
			"tag:yaml.org,2002:set": wc.set,
			"tag:yaml.org,2002:timestamp": bi.timestamp,
		};
	function Hh(t, e, r) {
		let i = dc.get(e);
		if (i && !t)
			return r && !i.includes(Jt.merge) ? i.concat(Jt.merge) : i.slice();
		let n = i;
		if (!n)
			if (Array.isArray(t)) n = [];
			else {
				let a = Array.from(dc.keys())
					.filter((o) => o !== "yaml11")
		...
		return (
			r && (n = n.concat(Jt.merge)),
			n.reduce((a, o) => {
				let s = typeof o == "string" ? fc[o] : o;
				if (!s) {
...
var fa = v((Nc) => {
	...
	var ua = P(),
		...
		Bh = Ft(),
		ki = yc(),
		Mh = (t, e) => (t.key < e.key ? -1 : t.key > e.key ? 1 : 0),
		da = class t {
			constructor({
				compat: e,
				customTags: r,
				...
				((this.compat = Array.isArray(e)
					...
					(this.knownTags = n ? ki.coreKnownTags : {}),
					(this.tags = ki.getTags(r, this.name, i)),
					(this.toStringOptions = s ?? null),
					Object.defineProperty(this, ua.MAP, { value: Dh.map }),
					Object.defineProperty(this, ua.SCALAR, { value: Bh.string }),
					Object.defineProperty(this, ua.SEQ, { value: Lh.seq }),
					(this.sortMapEntries =
						typeof o == "function" ? o : o === !0 ? Mh : null));
			}
			clone() {
				let e = Object.create(
					t.prototype,
...
var kc = v((bc) => {
	...
	function Vh(t, e) {
		...
		i && r.push("---");
		let n = ha.createStringifyContext(t, e),
			{ commentString: a } = n.options;
		if (t.commentBefore) {
			r.length !== 1 && r.unshift("");
			let c = a(t.commentBefore);
			r.unshift(Gt.indentComment(c, ""));
		}
		let o = !1,
			s = null;
		if (t.contents) {
			if (Fh.isNode(t.contents)) {
				if (
					(t.contents.spaceBefore && i && r.push(""), t.contents.commentBefore)
				) {
					let f = a(t.contents.commentBefore);
					r.push(Gt.indentComment(f, ""));
				}
				((n.forceBlockIndent = !!t.comment), (s = t.contents.comment));
			}
			let c = s ? void 0 : () => (o = !0),
				l = ha.stringify(t.contents, n, () => (s = null), c);
			(s && (l += Gt.lineComment(l, "", a(s))),
				(l[0] === "|" || l[0] === ">") && r[r.length - 1] === "---"
					? (r[r.length - 1] = `--- ${l}`)
					: r.push(l));
		} else r.push(ha.stringify(t.contents, n));
		if (t.directives?.docEnd)
			if (t.comment) {
				let c = a(t.comment);
				c.includes(`
`)
					? (r.push("..."), r.push(Gt.indentComment(c, "")))
					: r.push(`... ${c}`);
			} else r.push("...");
		else {
			let c = t.comment;
		...
		va = class t {
			constructor(e, r, i) {
				((this.commentBefore = null),
					...
					(this.errors = []),
					(this.warnings = []),
					Object.defineProperty(this, K.NODE_TYPE, { value: K.DOC }));
				let n = null;
				...
				(i?._directives
					...
					: (this.directives = new ma.Directives({ version: o })),
					this.setSchema(o, i),
					(this.contents = e === void 0 ? null : this.createNode(e, n, i)));
			}
			clone() {
				let e = Object.create(t.prototype, { [K.NODE_TYPE]: { value: K.DOC } });
				return (
					...
					(e.contents = K.isNode(this.contents)
			...
			add(e) {
				ht(this.contents) && this.contents.add(e);
			}
			addIn(e, r) {
				ht(this.contents) && this.contents.addIn(e, r);
			}
			createAlias(e, r) {
				if (!e.anchor) {
					let i = pa.anchorNames(this);
					e.anchor = !r || i.has(r) ? pa.findNewAnchor(r || "a", i) : r;
				}
				return new qh.Alias(e.anchor);
			}
			createNode(e, r, i) {
				let n;
				...
				let {
					...
					h = Kh.createNode(e, f, g);
				return (s && K.isCollection(h) && (h.flow = !0), d(), h);
			}
			createPair(e, r, i = {}) {
				let n = this.createNode(e, null, i),
					a = this.createNode(r, null, i);
				return new Wh.Pair(n, a);
			}
			delete(e) {
				return ht(this.contents) ? this.contents.delete(e) : !1;
			}
			deleteIn(e) {
				return ft.isEmptyPath(e)
					? this.contents == null
						? !1
			...
			get(e, r) {
				return K.isCollection(this.contents) ? this.contents.get(e, r) : void 0;
			}
			getIn(e, r) {
				return ft.isEmptyPath(e)
					? !r && K.isScalar(this.contents)
						? this.contents.value
						: this.contents
					: K.isCollection(this.contents)
						? this.contents.getIn(e, r)
						: void 0;
			}
			has(e) {
				return K.isCollection(this.contents) ? this.contents.has(e) : !1;
			}
			hasIn(e) {
				return ft.isEmptyPath(e)
			...
			set(e, r) {
				this.contents == null
					? (this.contents = ft.collectionFromPath(this.schema, [e], r))
					: ht(this.contents) && this.contents.set(e, r);
			}
			setIn(e, r) {
				ft.isEmptyPath(e)
					? (this.contents = r)
					: this.contents == null
						? (this.contents = ft.collectionFromPath(
								this.schema,
								Array.from(e),
								r,
							))
						: ht(this.contents) && this.contents.setIn(e, r);
			}
			setSchema(e, r = {}) {
				...
				switch (e) {
					case "1.1":
						(this.directives
							...
							: (this.directives = new ma.Directives({ version: "1.1" })),
					...
					case "next":
						(this.directives
							...
							: (this.directives = new ma.Directives({ version: e })),
				...
				else if (i) this.schema = new Jh.Schema(Object.assign(i, r));
				else
					throw new Error(
			...
			toString(e = {}) {
				...
				return Gh.stringifyDocument(this, e);
			}
		};
	function ht(t) {
		if (K.isCollection(t)) return !0;
...
var Qt = v((Ec) => {
	...
	function Xh(
		...
		for (let N of t)
			switch (
				...
				case "newline":
					...
					break;
				case "anchor":
					(p && a(N, "MULTIPLE_ANCHORS", "A node can have at most one anchor"),
						N.source.endsWith(":") &&
							a(
					...
					((p || y) &&
						...
						S &&
							a(
								N,
								"UNEXPECTED_TOKEN",
								`Unexpected ${N.source} in ${e ?? "collection"}`,
							),
						(S = N),
				...
				case "comma":
					if (e) {
						(k && a(N, "UNEXPECTED_TOKEN", `Unexpected , in ${e}`),
							(k = N),
							(l = !1),
							(f = !1));
						break;
		...
		let x = t[t.length - 1],
			A = x ? x.offset + x.source.length : n;
		return (
			g &&
				i &&
				i.type !== "space" &&
...
`)
			...
			case "flow-collection":
				for (let e of t.items) {
					...
					if (ya(e.key) || ya(e.value)) return !0;
				}
				return !1;
			default:
				return !0;
	...
	function ep(t, e, r) {
		...
		let n =
			typeof i == "function"
				...
				: (a, o) =>
						a === o ||
						(Pc.isScalar(a) && Pc.isScalar(o) && a.value === o.value);
...
var $c = v((jc) => {
	...
	var Ac = Pe(),
		...
		Ic = Na(),
		ip = ba(),
		Tc = "All mapping items must start at the same column";
	function np({ composeNode: t, composeEmptyNode: e }, r, i, n, a) {
		let o = a?.nodeClass ?? tp.YAMLMap,
			s = new o(r.schema);
		r.atRoot && (r.atRoot = !1);
		let c = i.offset,
			l = null;
		for (let f of i.items) {
			let { start: u, key: d, sep: m, value: g } = f,
				h = _c.resolveProps(u, {
...
` + h.comment)
				...
				(h.newlineAfterProp || rp.containsNewline(d)) &&
					n(
						d ?? u[u.length - 1],
						"MULTILINE_IMPLICIT_KEY",
						"Implicit keys need to be on a single line",
					);
			} else h.found?.indent !== i.indent && n(c, "BAD_INDENT", Tc);
			r.atKey = !0;
			let y = h.end,
				b = d ? t(r, d, h, n) : e(r, y, u, null, h, n);
			(r.schema.compat && Ic.flowIndentCheck(i.indent, d, n),
				(r.atKey = !1),
				ip.mapIncludes(r, s.items, b) &&
					n(y, "DUPLICATE_KEY", "Map keys must be unique"));
			let k = _c.resolveProps(m ?? [], {
			...
			if (((c = k.end), k.found)) {
				...
				let S = g ? t(r, g, k, n) : e(r, c, m, null, k, n);
				(r.schema.compat && Ic.flowIndentCheck(i.indent, g, n),
					(c = S.range[2]));
				let E = new Ac.Pair(b, S);
				(r.options.keepSourceTokens && (E.srcToken = f), s.items.push(E));
			} else {
				(p &&
					n(
						b.range,
...
var Hc = v((Oc) => {
	...
	var ap = _e(),
		op = Qt(),
		sp = Na();
	function cp({ composeNode: t, composeEmptyNode: e }, r, i, n, a) {
		let o = a?.nodeClass ?? ap.YAMLSeq,
			s = new o(r.schema);
		(r.atRoot && (r.atRoot = !1), r.atKey && (r.atKey = !1));
		let c = i.offset,
			l = null;
		for (let { start: f, value: u } of i.items) {
			let d = op.resolveProps(f, {
			...
			let m = u ? t(r, u, d, n) : e(r, d.end, f, null, d, n);
			(r.schema.compat && sp.flowIndentCheck(i.indent, u, n),
				(c = m.range[2]),
				s.items.push(m));
		}
		return ((s.range = [i.offset, c, l ?? c]), s);
	}
	Oc.resolveBlockSeq = cp;
});
var pt = v((Dc) => {
	"use strict";
	function lp(t, e, r, i) {
...
var Fc = v((Mc) => {
	...
	var up = P(),
		...
		pp = Si(),
		mp = ba(),
		ka = "Block collections are not allowed within flow collections",
		Sa = (t) => t && (t.type === "block-map" || t.type === "block-seq");
	function vp({ composeNode: t, composeEmptyNode: e }, r, i, n, a) {
		let o = i.start.source === "{",
			s = o ? "flow map" : "flow sequence",
			c = a?.nodeClass ?? (o ? Lc.YAMLMap : fp.YAMLSeq),
			l = new c(r.schema);
		l.flow = !0;
		let f = r.atRoot;
		...
		for (let p = 0; p < i.items.length; ++p) {
			...
			if (!x.found) {
				if (!x.anchor && !x.tag && !S && !E) {
					(p === 0 && x.comma
						? n(x.comma, "UNEXPECTED_TOKEN", `Unexpected , in ${s}`)
						: p < i.items.length - 1 &&
							n(x.start, "UNEXPECTED_TOKEN", `Unexpected empty item in ${s}`),
						x.comment &&
							(l.comment
								? (l.comment +=
										`
` + x.comment)
			...
			if (p === 0)
				x.comma && n(x.comma, "UNEXPECTED_TOKEN", `Unexpected , in ${s}`);
			else if (
				(x.comma || n(x.start, "MISSING_CHAR", `Missing , between ${s} items`),
				x.comment)
			) {
				let A = "";
				e: for (let N of b)
				...
				if (A) {
					...
					(up.isPair(N) && (N = N.value ?? N.key),
						N.comment
							? (N.comment +=
									`
` + A)
							: (N.comment = A),
						(x.comment = x.comment.substring(A.length + 1)));
				}
			}
			if (!o && !S && !x.found) {
				let A = E ? t(r, E, x, n) : e(r, x.end, S, null, x, n);
				(l.items.push(A),
					(u = A.range[2]),
					Sa(E) && n(A.range, "BLOCK_IN_FLOW", ka));
			} else {
				r.atKey = !0;
				let A = x.end,
					N = k ? t(r, k, x, n) : e(r, A, b, null, x, n);
				(Sa(k) && n(N.range, "BLOCK_IN_FLOW", ka), (r.atKey = !1));
				let $ = Bc.resolveProps(S ?? [], {
					flow: s,
					indicator: "map-value-ind",
					next: E,
					offset: N.range[2],
				...
				let ke = E
					...
					: $.found
						...
						: null;
				ke
					? Sa(E) && n(ke.range, "BLOCK_IN_FLOW", ka)
					: $.comment &&
						(N.comment
							? (N.comment +=
									`
` + $.comment)
							: (N.comment = $.comment));
				let nt = new dp.Pair(N, ke);
				if ((r.options.keepSourceTokens && (nt.srcToken = y), o)) {
					let O = l;
					(mp.mapIncludes(r, O.items, N) &&
						n(A, "DUPLICATE_KEY", "Map keys must be unique"),
						O.items.push(nt));
				} else {
					let O = new Lc.YAMLMap(r.schema);
					((O.flow = !0), O.items.push(nt));
					let Mo = (ke ?? N).range;
					((O.range = [N.range[0], Mo[1], Mo[2]]), l.items.push(O));
				}
				u = ke ? ke.range[2] : $.end;
			}
		}
		let d = o ? "}" : "]",
			[m, ...g] = i.end,
			h = u;
		if (m?.source === d) h = m.offset + m.source.length;
		else {
			let p = s[0].toUpperCase() + s.substring(1),
				y = f
					? `${p} must end with a ${d}`
					: `${p} in block collection must be sufficiently indented and end with a ${d}`;
			(n(u, f ? "MISSING_CHAR" : "BAD_INDENT", y),
				m && m.source.length !== 1 && g.unshift(m));
		}
		if (g.length > 0) {
			let p = hp.resolveEnd(g, h, r.options.strict, n);
			(p.comment &&
				(l.comment
					? (l.comment +=
							`
` + p.comment)
					: (l.comment = p.comment)),
				(l.range = [i.offset, h, p.offset]));
		} else l.range = [i.offset, h, h];
		return l;
	}
	Mc.resolveFlowCollection = vp;
});
var qc = v((Vc) => {
	"use strict";
	var gp = P(),
		...
		kp = Hc(),
		Sp = Fc();
	function Ea(t, e, r, i, n, a) {
		let o =
				r.type === "block-map"
					? bp.resolveBlockMap(t, e, r, i, a)
					: r.type === "block-seq"
						? kp.resolveBlockSeq(t, e, r, i, a)
						: Sp.resolveFlowCollection(t, e, r, i, a),
			s = o.constructor;
		return n === "!" || n === s.tagName
			? ((o.tag = s.tagName), o)
			: (n && (o.tag = n), o);
	}
	function Ep(t, e, r, i, n) {
		let a = i.tag,
			o = a
				? e.directives.tagName(a.source, (d) => n(a, "TAG_RESOLVE_FAILED", d))
				: null;
		if (r.type === "block-seq") {
			let { anchor: d, newlineAfterProp: m } = i,
				g = d && a ? (d.offset > a.offset ? d : a) : (d ?? a);
			g &&
				(!m || m.offset < g.offset) &&
		...
		if (
			...
			!o ||
			o === "!" ||
			(o === yp.YAMLMap.tagName && s === "map") ||
			(o === Np.YAMLSeq.tagName && s === "seq")
		)
			return Ea(t, e, r, n, o);
		...
		let l = Ea(t, e, r, n, o, c),
			f = c.resolve?.(l, (d) => n(a, "TAG_RESOLVE_FAILED", d), e.options) ?? l,
			u = gp.isNode(f) ? f : new wp.Scalar(f);
		return (
			(u.range = l.range), (u.tag = o), c?.format && (u.format = c.format), u
		);
	}
	Vc.composeCollection = Ep;
});
var Ca = v((Wc) => {
	"use strict";
	var xa = T();
	function xp(t, e, r) {
		let i = e.offset,
			n = Cp(e, t.options.strict, r);
		if (!n) return { value: "", type: null, comment: "", range: [i, i, i] };
		let a = n.mode === ">" ? xa.Scalar.BLOCK_FOLDED : xa.Scalar.BLOCK_LITERAL,
			o = e.source ? Pp(e.source) : [],
			s = o.length;
...
`.repeat(Math.max(1, o.length - 1))
				...
				p = i + n.length;
			return (
				e.source && (p += e.source.length),
				{ value: h, type: a, comment: n.comment, range: [i, p, p] }
			);
		}
		...
		for (let h = 0; h < s; ++h) {
			let [p, y] = o[h];
			if (y === "" || y === "\r")
				n.indent === 0 && p.length > c && (c = p.length);
			else {
				(p.length < c &&
					r(
						l + p.length,
...
`;
		...
		return { value: u, type: a, comment: n.comment, range: [i, g, g] };
	}
	function Cp({ offset: t, props: e }, r, i) {
			...
			switch (m.type) {
				...
				case "comment":
					(r &&
						...
						(u += m.source.length),
						(f = m.source.substring(1)));
					break;
				case "error":
					(i(m, "UNEXPECTED_TOKEN", m.message), (u += m.source.length));
					break;
				default: {
					let g = `Unexpected token in block scalar header: ${m.type}`;
					i(m, "UNEXPECTED_TOKEN", g);
					let h = m.source;
...
var Ra = v((Jc) => {
	...
	function Ap(t, e, r) {
		...
		switch (n) {
			case "scalar":
				((s = Pa.Scalar.PLAIN), (c = _p(a, l)));
				break;
			case "single-quoted-scalar":
				((s = Pa.Scalar.QUOTE_SINGLE), (c = Ip(a, l)));
				break;
			case "double-quoted-scalar":
				((s = Pa.Scalar.QUOTE_DOUBLE), (c = Tp(a, l)));
				break;
			default:
				return (
					r(
	...
	function _p(t, e) {
		...
		return (
			r && e(0, "BAD_SCALAR_START", `Plain value cannot start with ${r}`), zc(t)
		);
	}
	function Ip(t, e) {
		return (
...
var Kc = v((Uc) => {
	...
	function Lp(t, e, r, i) {
		let {
				...
				? Hp.resolveBlockScalar(t, e, i)
				: Dp.resolveFlowScalar(e, t.options.strict, i),
			c = r
				? t.directives.tagName(r.source, (u) => i(r, "TAG_RESOLVE_FAILED", u))
				: null,
			l;
		t.options.stringKeys && t.atKey
			? (l = t.schema[Ke.SCALAR])
			: c
				? (l = Bp(t.schema, n, c, r, i))
				: e.type === "scalar"
					? (l = Mp(t, n, e, i))
					: (l = t.schema[Ke.SCALAR]);
		let f;
		try {
			let u = l.resolve(
				n,
				(d) => i(r ?? e, "TAG_RESOLVE_FAILED", d),
				t.options,
			);
			f = Ke.isScalar(u) ? u : new Gc.Scalar(u);
		} catch (u) {
			let d = u instanceof Error ? u.message : String(u);
			(i(r ?? e, "TAG_RESOLVE_FAILED", d), (f = new Gc.Scalar(n)));
		}
		return (
			(f.range = s),
			(f.source = n),
	...
	function Bp(t, e, r, i, n) {
		if (r === "!") return t[Ke.SCALAR];
		let a = [];
		for (let s of t.tags)
	...
	function Mp({ atKey: t, directives: e, schema: r }, i, n, a) {
		let o =
			r.tags.find(
				(s) =>
		...
		if (r.compat) {
			let s =
				r.compat.find((c) => c.default && c.test?.test(i)) ?? r[Ke.SCALAR];
			if (o.tag !== s.tag) {
...
var el = v((_a) => {
	...
	var Vp = Tt(),
		...
		zp = pt(),
		Jp = Xc(),
		Gp = { composeNode: Zc, composeEmptyNode: Aa };
	function Zc(t, e, r, i) {
		let n = t.atKey,
		...
		switch (e.type) {
			...
			case "flow-collection":
				try {
					((l = Wp.composeCollection(Gp, t, e, r, i)),
						s && (l.anchor = s.source.substring(1)));
				} catch (u) {
					let d = u instanceof Error ? u.message : String(u);
			...
			default: {
				...
				(i(e, "UNEXPECTED_TOKEN", u), (f = !1));
			}
		}
		return (
			l ?? (l = Aa(t, e.offset, void 0, null, r, i)),
			s &&
				l.anchor === "" &&
			...
			o &&
				(e.type === "scalar" && e.source === ""
					? (l.comment = o)
					: (l.commentBefore = o)),
			t.options.keepSourceTokens && f && (l.srcToken = e),
			l
		);
	}
	function Aa(
		...
		let f = {
				type: "scalar",
				offset: Jp.emptyScalarPosition(e, r, i),
				indent: -1,
				source: "",
			},
			u = Qc.composeScalar(t, f, s, l);
		return (
			o &&
...
var il = v((rl) => {
	...
	var Kp = Ut(),
		...
		Yp = pt(),
		Xp = Qt();
	function Qp(t, e, { offset: r, start: i, value: n, end: a }, o) {
		let s = Object.assign({ _directives: e }, t),
			c = new Kp.Document(void 0, s),
			l = {
				atKey: !1,
				atRoot: !0,
		...
		(f.found &&
			...
			(c.contents = n
				? tl.composeNode(l, n, f, o)
				: tl.composeEmptyNode(l, f.end, i, null, f, o)));
		let u = c.contents.range[2],
			d = Yp.resolveEnd(a, u, !1, o);
		return (
		...
		constructor(e = {}) {
			((this.doc = null),
				...
				(this.onError = (r, i, n, a) => {
					let o = er(r);
					a
						? this.warnings.push(new Zt.YAMLWarning(o, i, n))
						: this.errors.push(new Zt.YAMLParseError(o, i, n));
				}),
				(this.directives = new em.Directives({ version: e.version || "1.2" })),
				(this.options = e));
		}
		decorate(e, r) {
			let { comment: i, afterEmptyLine: n } = al(this.prelude);
			if (i) {
				let a = e.contents;
				if (r)
					e.comment = e.comment
...
${i}`
				...
				else if (nl.isCollection(a) && !a.flow && a.items.length > 0) {
					let o = a.items[0];
					nl.isPair(o) && (o = o.key);
...
${o}`
		...
		streamInfo() {
			return {
				comment: al(this.prelude).comment,
		...
		*next(e) {
			switch ((Zp.env.LOG_STREAM && console.dir(e, { depth: null }), e.type)) {
				case "directive":
					...
					break;
				case "document": {
					let r = rm.composeDoc(this.options, this.directives, e, this.onError);
					(this.atDirectives &&
				...
				case "error": {
					let r = e.source
							...
							: e.message,
						i = new Zt.YAMLParseError(er(e), "UNEXPECTED_TOKEN", r);
				...
				case "doc-end": {
					if (!this.doc) {
						...
						this.errors.push(
							new Zt.YAMLParseError(er(e), "UNEXPECTED_TOKEN", i),
						);
						break;
					}
	...
	function sm(t, e = !0, r) {
		if (t) {
			let i = (n, a, o) => {
				...
				if (r) r(s, a, o);
				else throw new om.YAMLParseError([s, s + 1], a, o);
			};
			switch (t.type) {
				case "scalar":
				case "single-quoted-scalar":
				case "double-quoted-scalar":
					return am.resolveFlowScalar(t, e, i);
				case "block-scalar":
					return nm.resolveBlockScalar({ options: { strict: e } }, t, i);
			}
		}
		return null;
	}
	...
	function lm(t, e, r = {}) {
		...
		switch (c[0]) {
			...
			case ">":
				...
				break;
			case '"':
				ja(t, c, "double-quoted-scalar");
				break;
			case "'":
				ja(t, c, "single-quoted-scalar");
				break;
			default:
				ja(t, c, "scalar");
		}
...
`,
	...
	Ei.createScalarToken = cm;
	Ei.resolveAsScalar = sm;
	Ei.setScalarValue = lm;
});
var dl = v((ul) => {
	"use strict";
	var dm = (t) => ("type" in t ? Ci(t) : xi(t));
	function Ci(t) {
		switch (t.type) {
			case "block-scalar": {
				let e = "";
				for (let r of t.props) e += Ci(r);
				return e + t.source;
			}
			case "block-map":
			case "block-seq": {
				let e = "";
				for (let r of t.items) e += xi(r);
				return e;
			}
			case "flow-collection": {
	...
	function xi({ start: t, key: e, sep: r, value: i }) {
		let n = "";
		for (let a of t) n += a.source;
		if ((e && (n += Ci(e)), r)) for (let a of r) n += a.source;
		return (i && (n += Ci(i)), n);
	}
	ul.stringify = dm;
});
var ml = v((pl) => {
	"use strict";
	var $a = Symbol("break visit"),
		fm = Symbol("skip children"),
		fl = Symbol("remove item");
	function Ye(t, e) {
		("type" in t &&
			t.type === "document" &&
			(t = { start: t.start, value: t.value }),
			hl(Object.freeze([]), t, e));
	}
	Ye.BREAK = $a;
	Ye.SKIP = fm;
	Ye.REMOVE = fl;
	...
	Ye.parentCollection = (t, e) => {
		let r = Ye.itemAtPath(t, e.slice(0, -1)),
			i = e[e.length - 1][0],
			n = r?.[i];
		...
		for (let n of ["key", "value"]) {
			...
			if (a && "items" in a) {
				for (let o = 0; o < a.items.length; ++o) {
					let s = hl(Object.freeze(t.concat([[n, o]])), a.items[o], r);
					if (typeof s == "number") o = s - 1;
					else {
						if (s === $a) return $a;
						s === fl && (a.items.splice(o, 1), (o -= 1));
					}
				}
...
`:
	...
	W.createScalarToken = Oa.createScalarToken;
	W.resolveAsScalar = Oa.resolveAsScalar;
	W.setScalarValue = Oa.setScalarValue;
	W.stringify = hm.stringify;
	W.visit = pm.visit;
	W.BOM = Ha;
	W.DOCUMENT = Da;
	W.FLOW_END = La;
...
`:
	...
	var vl = new Set("0123456789ABCDEFabcdef"),
		ym = new Set(
...
` ||
				...
				if (r === "-" || r === ".") {
					...
					if ((i === "---" || i === "...") && Z(this.buffer[e + 3])) return -1;
				}
				return e;
			}
			getLine() {
...
`,
			...
			*parseStream() {
				...
				if (
					(e[0] === tr.BOM && (yield* this.pushCount(1), (e = e.substring(1))),
					e[0] === "%")
				) {
					let r = e.length,
						i = e.indexOf("#");
...
`,
			...
			*parseBlockScalarHeader() {
				...
				return yield* this.pushUntil((r) => Z(r) || r === "#");
			}
			*parseBlockScalar() {
				let e = this.pos - 1,
					r = 0,
...
`
			...
			*pushTag() {
				if (this.charAt(1) === "<") {
					let e = this.pos + 2,
						r = this.buffer[e];
					for (; !Z(r) && r !== ">";) r = this.buffer[++e];
					return yield* this.pushToIndex(r === ">" ? e + 1 : e, !1);
				} else {
					let e = this.pos + 1,
						r = this.buffer[e];
					for (; r;)
						if (ym.has(r)) r = this.buffer[++e];
						else if (
							r === "%" &&
							vl.has(this.buffer[e + 1]) &&
							vl.has(this.buffer[e + 2])
						)
							r = this.buffer[(e += 3)];
						else break;
...
var Ja = v((Sl) => {
	...
	function bl(t) {
		if (t.start.type === "flow-seq-start")
			for (let e of t.items)
				e.sep &&
					!e.value &&
					!Ie(e.start, "explicit-key-ind") &&
					!Ie(e.sep, "map-value-ind") &&
					(e.key && (e.value = e.key),
					delete e.key,
					kl(e.value)
						? e.value.end
							? _i(e.value.end, e.sep)
							: (e.value.end = e.sep)
						: _i(e.start, e.sep),
					delete e.sep);
	}
	var za = class {
		...
		*next(e) {
			if (
				((this.source = e),
				bm.env.LOG_TOKENS && console.log("|", yl.prettyToken(e)),
				this.atScalar)
			) {
				((this.atScalar = !1), yield* this.step(), (this.offset += e.length));
				return;
			}
			let r = yl.tokenType(e);
			if (r)
				if (r === "scalar")
				...
				case "comment":
					if (r.value) e.items.push({ start: [this.sourceToken] });
						...
						if (this.atIndentedComment(r.start, e.indent)) {
							...
							if (Array.isArray(n)) {
								(_i(n, r.start), n.push(this.sourceToken), e.items.pop());
								return;
							}
						}
						r.start.push(this.sourceToken);
			...
			if (this.indent >= e.indent) {
				...
				switch (this.type) {
					...
					case "map-value-ind":
						if (r.explicitKey)
							if (r.sep)
								...
								else if (Ie(r.sep, "map-value-ind"))
									this.stack.push({
										type: "block-map",
										offset: this.offset,
										indent: this.indent,
								...
								else if (kl(r.key) && !Ie(r.sep, "newline")) {
									let o = mt(r.start),
										s = r.key,
										c = r.sep;
					...
					default: {
						...
						if (o) {
							if (o.type === "block-seq") {
								if (!r.explicitKey && r.sep && !Ie(r.sep, "newline")) {
									yield* this.pop({
										type: "error",
										offset: this.offset,
		...
		*blockSequence(e) {
			...
			switch (this.type) {
				...
				case "seq-item-ind":
					...
					r.value || Ie(r.start, "seq-item-ind")
						? e.items.push({ start: [this.sourceToken] })
						: r.start.push(this.sourceToken);
					return;
			}
...
var Rl = v((ir) => {
	...
	function Cl(t) {
		...
		return {
			lineCounter: t.lineCounter || (e && new Cm.LineCounter()) || null,
			prettyErrors: e,
		};
	}
	function Pm(t, e = {}) {
		let { lineCounter: r, prettyErrors: i } = Cl(e),
			n = new xl.Parser(r?.addNewLine),
			a = new El.Composer(e),
			o = Array.from(a.compose(n.parse(t)));
		if (i && r)
			for (let s of o)
				(s.errors.forEach(rr.prettifyError(t, r)),
					s.warnings.forEach(rr.prettifyError(t, r)));
	...
	function Pl(t, e = {}) {
		...
		return (
			i &&
				r &&
				(o.errors.forEach(rr.prettifyError(t, r)),
				o.warnings.forEach(rr.prettifyError(t, r))),
			o
		);
	}
	function Rm(t, e, r) {
		...
		if (!n) return null;
		if (
			(n.warnings.forEach((a) => Em.warn(n.options.logLevel, a)),
			n.errors.length > 0)
		) {
	...
	function Am(t, e, r) {
		...
		return xm.isDocument(t) && !i
			? t.toString(r)
			: new Sm.Document(t, i, r).toString(r);
	}
	ir.parse = Rm;
	ir.parseAllDocuments = Pm;
	ir.parseDocument = Pl;
	ir.stringify = Am;
});
var vt = v((R) => {
	...
	var _m = Ta(),
		...
		Ii = Rl(),
		Al = Rt();
	R.Composer = _m.Composer;
	R.Document = Im.Document;
	R.Schema = Tm.Schema;
	R.YAMLError = Ga.YAMLError;
	R.YAMLParseError = Ga.YAMLParseError;
	R.YAMLWarning = Ga.YAMLWarning;
	R.Alias = jm.Alias;
	R.isAlias = Te.isAlias;
	R.isCollection = Te.isCollection;
	R.isDocument = Te.isDocument;
	R.isMap = Te.isMap;
	R.isNode = Te.isNode;
	R.isPair = Te.isPair;
	R.isScalar = Te.isScalar;
	R.isSeq = Te.isSeq;
	R.Pair = $m.Pair;
	R.Scalar = Om.Scalar;
	R.YAMLMap = Hm.YAMLMap;
	R.YAMLSeq = Dm.YAMLSeq;
	R.CST = Lm;
	R.Lexer = Bm.Lexer;
	R.LineCounter = Mm.LineCounter;
	R.Parser = Fm.Parser;
	R.parse = Ii.parse;
	R.parseAllDocuments = Ii.parseAllDocuments;
	R.parseDocument = Ii.parseDocument;
	R.stringify = Ii.stringify;
	R.visit = Al.visit;
	R.visitAsync = Al.visitAsync;
});
import je from "path";
function Ol(t) {
	let e = [...t],
		r = new Set(t);
	for (let i of $l) r.has(i) || (r.add(i), e.push(i));
	return e;
}
function Hl(t, e) {
	return gt[e][t];
...
function zm(t, e, r, i) {
	let n = /^(\s*)([a-z_]+):/u.exec(t);
	if (!n) return null;
	let a = n[1].length,
		o = n[2];
	if (a === 0 && o in gt.en) return o;
	if (a === 2 && e) {
		let s = `${e}.${o}`;
		if (s in gt.en) return s;
	}
	if (a === 4 && e === "knowledge" && i === "remote") {
		let s = `knowledge.remote.${o}`;
		if (s in gt.en) return s;
	}
	if (a === 4 && e === "knowledge" && i === "local") {
		let s = `knowledge.local.${o}`;
		if (s in gt.en) return s;
	}
	if (a === 2 && e === null && o === "hook") return "hook";
	if (a === 2 && e === "hook" && o === "allow_paths") return "hook.allow_paths";
	if (a === 4 && e === "native" && r === "snapshot") {
...
function sr(t, e) {
	let r = [],
		...
		n = null,
		a = null;
	for (let o of (0, ar.stringify)(t).trimEnd().split(`
`)) {
		let s = zm(o, i, n, a);
		if (s) {
			let c = o.match(/^\s*/u)?.[0] ?? "";
			for (let l of Hl(s, e).split(`
`))
				r.push(`${c}${l}`);
		}
		(r.push(o),
...
function Jm(t, e) {
	...
	if (
		r.length === 0 ||
		je.posix.isAbsolute(r) ||
		je.win32.isAbsolute(r) ||
		/^(?:~|[\\/])/u.test(r)
	)
...
function Xe(t) {
	let e = Jm(t, "native.artifact_root");
	return e.length === 0 ? "." : e.join("/");
}
function Dl(t, e = "docs") {
	let r = t ?? e;
	if (r !== "legacy" && r !== "docs")
...
function $i(t, e, r = !1) {
	...
	if (
		i.length === 0 ||
		je.posix.isAbsolute(i) ||
		je.win32.isAbsolute(i) ||
		/^(?:~|[\\/])/u.test(i)
	)
...
function Xa(t, e) {
	...
	if (t.length > Ti) throw new Error(`${e} exceeds ${Ti} characters`);
	let r = 0;
	for (let i = 0; i < t.length; i += 1)
		t[i] === "?"
			? (r += 1)
			: t[i] === "*" && ((r += 1), t[i + 1] === "*" && (i += 1));
	if (r > ji) throw new Error(`${e} contains more than ${ji} wildcard tokens`);
	return t;
}
function jl(t, e, r) {
	if (t === void 0) return [...r];
	if (!Array.isArray(t)) throw new Error(`${e} contains an unsafe pattern`);
	return [...new Set(t.map((i) => Xa(i, e)))].sort((i, n) =>
...
function Gm(t) {
	if (t === void 0)
		return { ...U, include: [...U.include], exclude: [...U.exclude] };
	let e = ve(t, "native.snapshot");
	return {
		include: jl(e.include, "native.snapshot.include", U.include),
		exclude: jl(e.exclude, "native.snapshot.exclude", U.exclude),
		max_files: Ua(e.max_files, U.max_files, "native.snapshot.max_files"),
		max_total_bytes: Ua(
			e.max_total_bytes,
			U.max_total_bytes,
...
function Km(t) {
	...
	if (je.posix.isAbsolute(i[0]) || je.win32.isAbsolute(i[0]))
		throw new Error(
			"native.finish.pull_request.command[0] must be a bare executable name or a project-relative path",
		);
	let n = r.timeout_ms ?? Vm;
	if (!Number.isSafeInteger(n) || n < 1 || n > Tl)
		throw new Error(
			`native.finish.pull_request.timeout_ms must be an integer between 1 and ${Tl}`,
		);
	return {
...
function Xm(t) {
	...
	return {
		artifact_layout: Dl(e.artifact_layout),
		language: Ll(e.language, "zh-CN", "classic.language"),
...
function Qm(t) {
	...
	return {
		allow_paths: [...new Set(r.map((i, n) => $i(i, `hook.allow_paths[${n}]`)))],
	};
}
function Zm(t) {
	if (t === void 0) return { ...nr };
	let e = ve(t, "memory"),
		r = e.learning ?? nr.learning,
		i = e.retrieval ?? nr.retrieval;
	if (typeof r != "boolean")
...
function ev(t, e) {
	...
	if (r.length > _l) throw new Error(`${e} exceeds ${_l} characters`);
	let i = 0;
	for (let n = 0; n < r.length; n += 1)
		r[n] === "?"
			? (i += 1)
			: r[n] === "*" && ((i += 1), r[n + 1] === "*" && (n += 1));
	if (i > Il) throw new Error(`${e} contains more than ${Il} wildcard tokens`);
	return r;
}
function tv(t) {
	let r = Qa(t, "knowledge.local").include ?? [];
	if (!Array.isArray(r))
		throw new Error("knowledge.local.include must be an array");
	return {
		include: [
			...new Set(r.map((i, n) => ev(i, `knowledge.local.include[${n}]`))),
		],
	};
}
function rv(t) {
...
function nv(t) {
	if (t === void 0) return { ...Ya };
	let e = Qa(t, "knowledge"),
		r = e.provider ?? "local";
	if (r !== "local" && r !== "remote")
		throw new Error("knowledge.provider must be local or remote");
	let i = e.local === void 0 ? void 0 : tv(e.local);
	if (r === "local") return { provider: r, ...(i ? { local: i } : {}) };
	let n = e.remote === void 0 ? void 0 : iv(e.remote);
	if (n === void 0)
		throw new Error(
...
function ov(t, e, r, i, n, a, o, s) {
	...
	let f = t.workflows ?? [t.default_workflow];
	if (
		!Array.isArray(f) ||
		f.length === 0 ||
...
function wt(t, e = {}) {
	let r = (0, ar.parseDocument)(t, { uniqueKeys: !0 });
	...
	let n = i,
		a = av(n.ambient_resume),
		o = n.hook === void 0 ? void 0 : Qm(n.hook),
		s = Zm(n.memory),
		c = nv(n.knowledge),
		l =
			n.native === void 0
		...
		f = n.classic === void 0 ? void 0 : Xm(n.classic),
		u = ov(n, o, s, c, l, f, a, {
			...
			? {
					native: {
						...
						...(t.native.pending_root_move
							? { pending_root_move: Bl(t.native.pending_root_move) }
							: {}),
					},
				}
			: {}),
...
function cr(t, e) {
	...
	if (
		(i.hook &&
			(n.hook = { ...G(t.hook), allow_paths: [...i.hook.allow_paths] }),
		i.memory)
	) {
		let a = G(t.memory);
		n.memory = {
	...
	if (i.knowledge) {
		...
		if (
			(i.knowledge.local && i.knowledge.local.include.length > 0
				? (o.local = { ...G(a.local), include: [...i.knowledge.local.include] })
				: delete o.local,
			i.knowledge.remote)
		) {
			let c = {
	...
	if (i.native) {
		...
		if ((delete o.snapshot, i.native.pending_root_move)) {
			let s = G(a.pending_root_move),
				c = Bl(i.native.pending_root_move),
				l = G(s.cleanup),
				f = G(c.cleanup);
			o.pending_root_move = {
				...s,
...
function Oi(t = "docs", e = "en") {
	return {
		...
		native: {
			...
			max_verify_failures: Ka,
			snapshot: { ...U, include: [...U.include], exclude: [...U.exclude] },
		},
	};
}
var ar,
	...
	$e = w(() => {
		...
		((ar = Pt(vt(), 1)),
			...
			($l = [...qm, ...Wm].sort((t, e) => t.localeCompare(e, "en"))));
		((U = {
			include: ["**/*"],
			exclude: [...$l],
			max_files: 1e4,
...
function He(t, e) {
	return Oe(t.dev) && Oe(e.dev) && Oe(t.ino) && Oe(e.ino);
}
function D(t, e) {
	let r = Oe(t.dev) && Oe(e.dev);
	if (r && t.dev !== e.dev) return !1;
	let i = Oe(t.ino) && Oe(e.ino);
	return i && t.ino !== e.ino ? !1 : r && i ? !0 : t.birthtime === e.birthtime;
}
var lr = w(() => {
	"use strict";
});
import { constants as Hi, promises as Qe } from "fs";
function Za(t) {
...
function ur(t) {
	return { dev: t.dev, ino: t.ino, birthtime: Za(t) };
}
function Di(t, e) {
	let r = ur(t),
		i = ur(e);
	return He(r, i)
		? D(r, i)
		: D(r, i) && Za(t) === Za(e) && Fl(t) === Fl(e) && t.size === e.size;
}
async function dr(t, e, r = {}) {
	...
	let i = r.label ?? "file",
		n = r.bigint === !0,
		a = await Qe.lstat(t, { bigint: n });
	if (!a.isFile() || a.isSymbolicLink())
		throw new oe("not-regular-file", `${i} must be a regular file`);
	if (BigInt(a.size) > BigInt(e))
		throw new oe("too-large", `${i} exceeds ${e} bytes`);
	let o = await Qe.realpath(t);
	await r.verify?.("pre-open", { realPath: o, identity: ur(a) });
	let s =
			process.platform === "win32"
				? Hi.O_RDONLY
				: Hi.O_RDONLY | Hi.O_NOFOLLOW | Hi.O_NONBLOCK,
		c;
	try {
		c = await Qe.open(t, s);
	} catch (l) {
		throw l.code === "ELOOP"
			? new oe("not-regular-file", `${i} must be a regular file`, { cause: l })
			: l;
	}
	try {
		...
		if (
			...
			throw new oe("changed", `${i} changed while opening`);
		(await r.verify?.("post-open", { realPath: u, identity: ur(l) }),
		...
		for (;;) {
			let b = e + 1 - m,
				{ bytesRead: k } = await c.read(g, 0, Math.min(g.length, b), null);
			if (k === 0) break;
			if (((m += k), m > e))
				throw new oe("too-large", `${i} exceeds ${e} bytes`);
			d.push(Buffer.from(g.subarray(0, k)));
		}
		await r.hooks?.beforeFinalCheck?.();
		let [h, p, y] = await Promise.all([
			c.stat({ bigint: n }),
			Qe.lstat(t, { bigint: n }),
			Qe.realpath(t),
		]);
		if (!p.isFile() || p.isSymbolicLink() || y !== o || !Di(a, h) || !Di(a, p))
			throw new oe("changed", `${i} changed while reading`);
		return (
			await r.verify?.("post-read", { realPath: y, identity: ur(h) }),
			{ bytes: Buffer.concat(d, m), stat: h, realPath: y }
		);
	} finally {
		await c.close();
	}
...
function eo(t, e) {
	let r = De.relative(t, e);
	return (
		r === "" ||
		(!De.isAbsolute(r) && r !== ".." && !r.startsWith(`..${De.sep}`))
	);
}
...
async function ql(t, e, r, i) {
	...
	for (let a = 0; a < r.length; a++) {
		...
		try {
			...
			if (sv(f)) return { exists: !1, kind: "missing" };
			throw f;
		}
		let s = De.relative(t, n).replaceAll("\\", "/");
		if (o.isSymbolicLink())
...
async function se(t, e, r, i) {
	let n = await ge(t, e, { label: i.label, expected: "file" });
	if (!n.exists) {
		let o = new Error(`${i.label} does not exist`);
		throw ((o.code = "ENOENT"), o);
	}
	let a = await Vl(n.projectRoot, i.label);
	return dr(n.target, r, {
		...i,
		verify: async (o, s) => {
			if (!eo(a, s.realPath))
				throw new Error(`${i.label} resolves outside the project root`);
			await ql(n.projectRoot, a, n.relative.split("/"), {
				label: i.label,
				expected: "file",
			});
		},
...
import { createHash as cv } from "crypto";
function to(t, e) {
...
async function Bi(t, e = {}) {
	return (await pr(t, e)).document;
}
async function Wl(t) {
	try {
		return (await se(t, hr, or, { label: hr })).bytes;
	} catch (e) {
		if (lv(e)) return null;
		throw e;
	}
...
function zl(t) {
	return t
		? { exists: !0, sha256: cv("sha256").update(t).digest("hex") }
		: { exists: !1, sha256: null };
}
async function Mi(t) {
	return zl(await Wl(t));
}
async function pr(t, e = {}) {
	let r = await Wl(t);
	return { document: r ? wt(r.toString("utf8"), e) : null, identity: zl(r) };
}
async function ro(t) {
	return (await Bi(t))?.config ?? null;
}
var hr,
	yt = w(() => {
		"use strict";
		$e();
		Ze();
		hr = ".comet/config.yaml";
	});
import { randomUUID as uv } from "crypto";
import { constants as dv, promises as M } from "fs";
import ee from "path";
async function io(t, e) {
	try {
		return (await M.link(t, e), { linked: !0 });
	} catch (r) {
		let i = r.code;
		if (i !== "ENOTSUP" && i !== "EOPNOTSUPP") throw r;
	}
	return (await M.copyFile(t, e, dv.COPYFILE_EXCL), { linked: !1 });
}
function Fi(t, e) {
...
async function Jl(t) {
	let e = await M.lstat(t);
	if (!e.isDirectory() || e.isSymbolicLink())
		throw new Error(
			`Contained atomic write parent must be a real directory: ${t}`,
		);
	return { path: t, realPath: await M.realpath(t), ...Vi(e) };
}
async function Nt(t) {
	for (let e of t) {
		let r = await M.lstat(e.path);
		if (
			!r.isDirectory() ||
			r.isSymbolicLink() ||
			!fv(e, r) ||
			(await M.realpath(e.path)) !== e.realPath
		)
			throw new Error(
...
async function pv(t, e, r) {
	let [i, n] = await Promise.all([M.lstat(t), M.realpath(t), Nt(r)]);
	if (!i.isFile() || i.isSymbolicLink() || !qi(i, e) || !Fi(r[0].realPath, n))
		throw new Error(
...
async function mv(t, e) {
	...
	for (let s of a) {
		...
		let c = await Jl(o);
		if (!Fi(n[0].realPath, c.realPath))
			throw new Error(
				`Contained atomic write parent resolves outside its managed root: ${o}`,
			);
		n.push(c);
	}
	return (await Nt(n), n);
...
async function vv(t) {
	let e;
	try {
		((e = await M.open(t, "r")), await e.sync());
	} catch (r) {
		let i = r.code;
		if (
...
async function gv(t, e, r) {
	let i = ee.dirname(t),
		n = await mv(r.containedRoot, i),
		a = ee.join(i, `.${ee.basename(t)}.${uv()}.tmp`),
		o,
		s,
		c;
	try {
		(await r.beforeTemporaryOpen?.(),
			(o = await M.open(a, "wx")),
			(s = await o.stat()));
		let [l, f] = await Promise.all([M.lstat(a), M.realpath(a)]);
		if (
			(await Nt(n),
			!l.isFile() || l.isSymbolicLink() || !qi(s, l) || !Fi(n[0].realPath, f))
		)
			throw new Error(
		...
		((c = await pv(a, c, n)), await r.beforeCommit?.(), await Nt(n));
		let u = await M.lstat(a);
		if (!u.isFile() || u.isSymbolicLink() || !c || !hv(u, c))
			throw new Error(
				"Contained atomic write temporary file changed before commit",
			);
		(r.exclusive ? (await io(a, t), await M.unlink(a)) : await M.rename(a, t),
			await vv(i));
	} catch (l) {
		await o?.close();
		try {
			(await Nt(n), await M.rm(a, { force: !0 }));
		} catch {}
		throw l;
	}
}
...
import { randomUUID as Nv } from "crypto";
import { promises as L } from "fs";
import te from "path";
function Wi(t, e) {
	let r = te.relative(t, e);
	return (
		r === "" ||
		(!te.isAbsolute(r) && r !== ".." && !r.startsWith(`..${te.sep}`))
	);
}
function bv(t, e) {
	return D(
...
async function kt(t) {
	for (let e of t) {
		let r = await L.lstat(e.path);
		if (
			!r.isDirectory() ||
			r.isSymbolicLink() ||
			!bv(e, r) ||
			(await L.realpath(e.path)) !== e.realPath
		)
			throw new Error(
...
async function Ev(t, e) {
	...
	let n = [await Gl(r)],
		a = te.relative(r, i).split(te.sep).filter(Boolean),
		o = r;
	for (let s of a) {
		(await kt(n), (o = te.join(o, s)));
		try {
			await L.mkdir(o);
		} catch (l) {
			if (l.code !== "EEXIST") throw l;
...
async function xv(t) {
	let e;
	try {
		((e = await L.open(t, "r")), await e.sync());
	} catch (r) {
		let i = r.code;
		if (
			!["EACCES", "EBADF", "EINVAL", "EISDIR", "ENOTSUP", "EPERM"].includes(
...
async function Cv(t, e, r = {}) {
	let i = te.dirname(t),
		n = r.containedRoot ? await Ev(r.containedRoot, i) : null;
	n || (await L.mkdir(i, { recursive: !0 }));
	let a = te.join(i, `.${te.basename(t)}.${Nv()}.tmp`),
		o,
		s,
		c;
	try {
		if (
			...
			let [l, f] = await Promise.all([L.lstat(a), L.realpath(a)]);
			if (
				(await kt(n),
				!l.isFile() || l.isSymbolicLink() || !zi(s, l) || !Wi(n[0].realPath, f))
			)
				throw new Error(
		...
		if (((c = await Sv(a, c, n)), await r.beforeCommit?.(), n)) {
			await kt(n);
			let l = await L.lstat(a);
			if (!l.isFile() || l.isSymbolicLink() || !c || !kv(l, c))
				throw new Error(
					"Native atomic write temporary file changed before commit",
				);
		}
		(r.exclusive
			? (await L.link(a, t), await L.unlink(a))
			: await L.rename(a, t),
			await xv(i));
	} catch (l) {
		if ((await o?.close(), !n)) await L.rm(a, { force: !0 });
		else
			try {
				(await kt(n), await L.rm(a, { force: !0 }));
			} catch {}
		throw l;
	}
}
...
import { existsSync as MN, promises as ye } from "fs";
import _ from "path";
import Pv from "os";
async function so(t) {
	try {
		return (await ye.lstat(t), !0);
	} catch (e) {
...
async function Rv(t) {
	try {
		let e = await ye.readFile(t, "utf8");
...
async function St(t) {
	...
	let i = await ye.realpath(r);
	return _.resolve(i, ...e.reverse());
}
async function co(t) {
	try {
		return (await ye.lstat(t)).isSymbolicLink();
	} catch (e) {
		if (e.code === "ENOENT") return !1;
		throw e;
	}
...
async function lo(t) {
	let e = _.resolve(t);
	try {
		(await ye.stat(e)).isDirectory() || (e = _.dirname(e));
	} catch (n) {
		if (n.code !== "ENOENT") throw n;
	}
	let r = e,
		i = _.resolve(Pv.homedir());
	for (;;) {
		if (!(e === i && r !== i)) {
			let o = _.join(e, ...Ji.split("/")),
				s = e === r || (await Rv(o));
			if ((await so(o)) && s) return e;
		}
		if (await so(_.join(e, ".git"))) return e;
		let a = _.dirname(e);
		if (a === e) return r;
		e = a;
	}
...
async function tt(t, e) {
	...
	let [a, o] = await Promise.all([St(i), St(n)]);
	if (!mr(a, o))
		throw new Error(
	...
	let [l, f] = await Promise.all([ye.realpath(s), St(c)]);
	if (!mr(l, f))
		throw new Error(
...
async function Ul(t) {
	(await Promise.all(
		[t.specsDir, t.changesDir, t.archiveDir].map(async (e) => {
			(await F(t.nativeRoot, e), await ye.mkdir(e, { recursive: !0 }));
		}),
	),
		await Promise.all(
			[t.changesRuntimeDir, t.locksDir, t.transactionsDir].map(async (e) => {
				(await F(t.projectRoot, e), await ye.mkdir(e, { recursive: !0 }));
			}),
		));
}
async function F(t, e) {
	let r = _.resolve(t),
		i = _.resolve(e);
	if (!mr(r, i)) throw new Error(`Path is outside the Native root: ${e}`);
	if (await co(r))
		throw new Error(`Native root must not be a symbolic link: ${t}`);
	let [n, a] = await Promise.all([St(r), St(i)]);
	if (!mr(n, a)) throw new Error(`Path resolves outside the Native root: ${e}`);
	return i;
}
var Ji,
	I = w(() => {
		"use strict";
		$e();
		Ji = ".comet/config.yaml";
	});
import _v from "path";
function Yl(t = "docs", e = "en") {
	return Oi(t, e);
}
async function le(t) {
	let e = (await Bi(t))?.config ?? null;
	return e?.native ? e : null;
}
async function gr(t, e, r = {}) {
	let i = await pr(t, { allowPartialProject: !0 }),
		n = cr(i.document?.value ?? {}, e),
		a = _v.join(t, ...Ji.split("/"));
	await we(a, sr(n, e.native.language === "zh-CN" ? "zh-CN" : "en"), {
		containedRoot: t,
		beforeCommit: async () => {
			(await r.beforeCommit?.(), await ao(t, i.identity));
		},
	});
}
var Kl,
...
import { promises as Iv } from "node:fs";
...
function Hv(t) {
	...
	for (let i of $v(t)) {
		let n = Ov(i);
		if (n === Ql) {
			if (r) throw new Error("Comet .gitignore managed block is malformed");
			r = !0;
			continue;
		}
		if (n === Zl) {
	...
	if (r) throw new Error("Comet .gitignore managed block is incomplete");
	return e.join("");
}
function eu(t) {
	let e = jv(t),
	...
	return (
		r.length > 0 && !/(?:\r\n|\n|\r)$/u.test(r) && (r += e),
		r + [Ql, "!/.comet/", "/.comet/*", "!/.comet/config.yaml", Zl, ""].join(e)
	);
}
async function uo(t) {
	let e = Tv.resolve(t),
		r = await ge(e, wr, { label: "project .gitignore", expected: "file" }),
		i = "",
		n = new Uint8Array();
	r.exists &&
		((n = (await se(e, wr, Xl, { label: "project .gitignore" })).bytes),
		(i = Buffer.from(n).toString("utf8")));
	let a = eu(i);
	a !== i &&
		(await et(r.target, a, {
			containedRoot: e,
			exclusive: !r.exists,
			beforeCommit: r.exists
				? async () => {
						if (
							!(
								await se(e, wr, Xl, { label: "project .gitignore" })
							).bytes.equals(n)
						)
							throw new Error(
								"Project .gitignore changed before commit; rerun initialization",
							);
					}
				: async () => {
						if (
							...
							throw new Error(
								"Project .gitignore was created before commit; rerun initialization",
							);
					},
		}),
		await ge(e, wr, { label: "project .gitignore", expected: "file" }),
		await Iv.access(r.target));
}
var wr,
	Xl,
	Ql,
	...
	fo = w(() => {
		...
		((wr = ".gitignore"),
			(Xl = 4 * 1024 * 1024),
			(Ql = "# >>> Comet managed project state >>>"),
			(Zl = "# <<< Comet managed project state <<<"));
	});
import { execFileSync as Dv } from "child_process";
import Gi from "path";
function ho(t, e) {
	return Dv("git", ["-C", t, ...e], {
		encoding: "utf8",
...
function Le(t) {
	try {
		let e = Gi.resolve(ho(t, ["rev-parse", "--show-toplevel"])),
			i = ho(t, ["worktree", "list", "--porcelain", "-z"])
				.split("\0")
				.find((o) => o.startsWith("worktree ")),
			n = i ? Gi.resolve(i.slice(9)) : e,
			a = null;
		try {
			a = ho(t, ["symbolic-ref", "--quiet", "--short", "HEAD"]) || null;
		} catch {}
		return {
			isGitWorktree: !0,
			isSecondaryWorktree: !Lv(e, n),
...
var po,
	...
	rt = w(() => {
		...
		for (let t of Object.keys(po)) {
			for (let [e, r] of Object.entries(po[t]))
				Fv.set(r.toLocaleLowerCase("en-US"), e);
			for (let [e, r] of Object.entries(Bv[t]))
				nu.set(r.toLocaleLowerCase("en-US"), e);
			for (let [e, r] of Object.entries(Mv[t]))
				nu.set(r.toLocaleLowerCase("en-US"), e);
		}
	});
var yr = w(() => {
...
import { AsyncLocalStorage as qv } from "async_hooks";
var Cb,
	Pb,
	Nr = w(() => {
		"use strict";
		...
		I();
		ce();
		((Cb = 16 * 1024), (Pb = new qv()));
	});
import { createHash as Wv } from "crypto";
function re(t) {
	throw new TypeError(`Value is not valid canonical JSON: ${t}`);
}
function zv(t, e) {
	(e.has(t) && re("cyclic structures are not supported"), e.add(t));
	try {
		let r = Object.keys(t);
		for (let i = 0; i < t.length; i += 1)
			Object.prototype.hasOwnProperty.call(t, i) ||
				re("sparse arrays are not supported");
		return (
			(r.length !== t.length || r.some((i, n) => i !== String(n))) &&
				re("arrays must not have named enumerable properties"),
			Object.getOwnPropertySymbols(t).length > 0 &&
				re("symbol properties are not supported"),
			`[${t.map((i) => go(i, e)).join(",")}]`
		);
	} finally {
		e.delete(t);
...
function Jv(t, e) {
	...
	(r !== Object.prototype &&
		r !== null &&
		re("only plain objects are supported"),
		e.has(t) && re("cyclic structures are not supported"),
		Object.getOwnPropertySymbols(t).length > 0 &&
			re("symbol properties are not supported"),
		e.add(t));
	try {
		...
		return `{${Object.keys(t)
			...
			.map((o) => {
				...
				return (
					(!s || !("value" in s)) &&
						re("accessor properties are not supported"),
					`${JSON.stringify(o)}:${go(s.value, e)}`
				);
			})
			.join(",")}}`;
	} finally {
...
function go(t, e) {
	...
	switch (typeof t) {
		...
		case "number":
			return (
				Number.isFinite(t) || re("numbers must be finite"),
				JSON.stringify(Object.is(t, -0) ? 0 : t)
			);
		case "object":
			return Array.isArray(t) ? zv(t, e) : Jv(t, e);
		case "bigint":
		case "function":
		case "symbol":
		case "undefined":
			return re(`${typeof t} values are not supported`);
	}
	return re("unsupported value type");
}
function wo(t) {
	return go(t, new Set());
}
...
var jb,
	...
	Ki = w(() => {
		...
		((jb = Object.freeze({
			...
			(au = Object.freeze({ maxCriteria: 1024 })));
	});
var yo = w(() => {
	"use strict";
	Ki();
...
var du,
	...
	No = w(() => {
		...
		ue();
		lu();
		((du = "[a-z][a-z0-9]*(?:-[a-z0-9]+)*"),
			(rk = new RegExp(`^portable-archive-(${du})\\.json$`, "u")),
			(ik = new RegExp(`^portable-migration-(${du})\\.json$`, "u")));
	});
var de = w(() => {
	"use strict";
	j();
...
import { TextDecoder as ng } from "util";
var mk,
	vk,
	gk,
	wk,
...
import { createHash as og } from "crypto";
function X(t) {
	return og("sha256").update(t).digest("hex");
}
var he = w(() => {
	"use strict";
});
...
var dS,
	ku = w(() => {
		...
		dS = Nu(
			"hookWritePolicy",
			async (t) => (await ro(t))?.hook ?? { allow_paths: [] },
		);
	});
var Su = w(() => {
	"use strict";
...
var IE,
	...
	rn = w(() => {
		...
		ie();
		I();
		((IE = 16 * 1024), (TE = process.platform));
	});
var Iu,
	Tu,
	ix,
	...
	V = w(() => {
		...
		((Tu = [
			...
			(ix = new Set(Tu)),
			(yg = new Set([...Tu, "minimum_runtime_version", "revision"])),
			(nx = new Set([
				...yg,
...
var Ou,
	...
	Co = w(() => {
		...
		((Ou = "scoped-text-safety"),
			...
			(xg = "comet.native.checker-policy.v1"),
			(_x = z(xg, {
				policy: Ou,
				version: Sg,
				limits: Eg,
...
fr();
import Ir from "path";
import { realpathSync as Iw } from "fs";
Be();
var Ne = {
	next: "NEXT:",
	relay: "RELAY TO USER:",
...
function ru(t, e) {
	...
	return (
		i && r.push(i),
		t.user_message && r.push("", Ne.relay, t.user_message),
		e !== void 0 && r.push("", Ne.details, JSON.stringify(e, null, 2)),
		`${r.join(`
`)}
`
	);
...
function iu(t, e, r) {
	...
	return (
		n && i.push(n),
		t.user_message && i.push("", Ne.relay, t.user_message),
		i.push("", `${Ne.detail} ${e}`),
		r !== void 0 && i.push("", Ne.details, JSON.stringify(r, null, 2)),
		i.join(`
`)
	);
}
...
he();
I();
var bg = ["outcome", "scope", "nonGoals", "acceptanceExamples"],
	hx = [
		...bg,
		"constraints",
		"decisions",
...
var Hu = {
	...
	Ig = X("comet-native-runtime:v3:scope-reopen"),
	bC = [
		{
			skillVersion: "3",
...
var Lu = [
	...
	tP = new Set(Lu),
	Lg = new Set([...Lu, "minimum_runtime_version", "revision"]),
	rP = new Set([...Lg, "operation"]),
	iP = 512 * 1024,
	Bg = new Set([
		"previousPhase",
		"nextPhase",
...
Ki();
J();
var lP = { maxAcceptanceCriteria: au.maxCriteria };
var pP = { maxSpecs: 64, maxFileBytes: vo, maxTotalBytes: 4 * 1024 * 1024 };
xt();
kr();
Et();
on();
import { execFile as Yg } from "node:child_process";
cn();
Po();
V();
import { promisify as Xg } from "node:util";
V();
j();
V();
he();
...
function yw(t, e, r) {
	...
	let a = C(i, `Change ${t.change}`, `需求 ${t.change}`),
		o = zu(t.phase, i),
		s = ww(t.disposition, t.userCommunication.required, i);
	(n.push([a, o || null, s].filter(Boolean).join(" · ")),
		e && e.total > 0 && n.push(Ju(e, i)));
			...
			t.status === "await-user"
				...
				: t.status === "blocked"
					...
					: t.status === "done"
						? C(e, "complete", "已完成")
						: C(e, "in progress", "进行中"),
		a = $o(t.acceptance) ? `${C(e, ", ", "，")}${Ju(t.acceptance, e)}` : "";
	...
	if (Nw(e)) {
		...
		return {
			summary: [
				...
				...e.items.map((a) => bw(a, i)),
			].join(`
`),
		};
	}
	let r = e.continuation;
	if (Gu(r)) return yw(r, Cw(e), Pw(e, Oo(r)));
...
function Cw(t) {
	if ($o(t.acceptance)) return t.acceptance;
	let e = t.state;
	if (e && typeof e == "object" && !Array.isArray(e)) {
		let r = e;
		if ($o(r.acceptance)) return r.acceptance;
		if (Array.isArray(r.acceptance)) return gw(r.acceptance);
	}
	return null;
}
function Pw(t, e) {
...
function Rw(t) {
	...
	return Do[r] || (e.length > 1 && Do[e[0]]?.subcommands) ? r : e[0];
}
function Aw(t = []) {
	let e = Rw(t),
		r = Do[e];
	...
	r.subcommands && i.push("", Ho("Commands", r.subcommands));
	let n = e === "" ? r.options : [...(r.options ?? []), ...Xu];
	return (
		n && n.length > 0 && i.push("", Ho("Options", n)),
		i.push(
			"",
			`Output:
  ${r.output}`,
		),
		r.examples && i.push("", Ho("Examples", r.examples)),
		e === "" &&
			i.push(
				"",
...
function Bo(t, e) {
	...
	if (r.length > 1) throw new We(`${e} may only be provided once`);
...
function Tr(t, e) {
	...
	let i = r[0],
		n = t[i + 1];
	if (n === void 0 || n.startsWith("--")) throw new We(`${e} requires a value`);
	return (t.splice(i, 2), n);
}
function Zu(t) {
	if (t.length > 0) throw new We(`Unexpected argument: ${t[0]}`);
}
function ed(t, e = "en") {
	let r = Tr(t, "--language") ?? e;
	if (r !== "en" && r !== "zh-CN")
		throw new We("--language must be en or zh-CN");
	return r;
}
function Lo(t, e) {
	let r = Ir.normalize(Qu(t)),
		i = Ir.normalize(Qu(e));
	return process.platform === "win32"
		? r.toLowerCase() === i.toLowerCase()
		: r === i;
...
function Tw(t) {
	...
	return !i.isGitWorktree ||
		...
		!Lo(r.primaryWorktreeRoot, i.primaryWorktreeRoot) ||
		Lo(r.currentWorktreeRoot, i.currentWorktreeRoot)
		? e
		: Lo(process.cwd(), r.currentWorktreeRoot)
			? Ir.resolve(process.cwd())
			: r.currentWorktreeRoot;
}
async function td(t) {
	return t ? Tw(t) : lo(process.cwd());
}
function rd(t) {
	return (
...
function id(t, e, r) {
	return { command: t, exitCode: 0, data: e, text: r ?? rd(e) };
}
function jw(t, e) {
	if (e instanceof We)
		return {
...
function nd(t, e) {
	let r = jw(t, e),
		i = r.error;
	if (!i) return r;
	let n = Yu({ code: i.code, message: i.message, data: r.data });
	return n ? { ...r, envelope: n } : r;
}
function ad(t, e, r = !1) {
	let i = t.envelope ?? Ku(t.data);
	return e
		? {
				exitCode: t.exitCode,
				stdout:
...
`,
		...
		: t.error
			? {
					exitCode: t.exitCode,
					stderr: i
						? iu(i, t.error.message, r ? t.data : void 0)
						: t.error.message,
				}
			: i
				? { exitCode: t.exitCode, stdout: ru(i, r ? t.data : void 0) }
				: r && t.text !== void 0 && t.data !== void 0 && t.text !== rd(t.data)
					? {
							exitCode: t.exitCode,
							stdout: `${t.text}
${Ne.details}
...
async function od(t, e) {
	let r = Tr(t, "--root"),
		i = await le(e),
		n = ed(t, i?.native.language ?? "en");
	if ((Zu(t), i?.native.pending_root_move))
		throw new Error(
			`Native root move ${i.native.pending_root_move.id} is incomplete`,
		);
	let a = vr(r ?? i?.native.artifact_root ?? "docs");
	if (i && r && i.native.artifact_root !== a)
		throw new Error(
			`Configured Native artifact root is ${i.native.artifact_root}; refusing conflicting root ${a}`,
		);
	let o = i
			? {
					...i,
					native: {
						...
						snapshot: {
							...i.native.snapshot,
							exclude: Kl(i.native.snapshot.exclude),
						},
					},
				}
			: Yl(a, n),
		s = await tt(e, o.native.artifact_root);
	return (
		await Ul(s),
		await uo(e),
		await gr(e, o),
		id(
			...
			{
				projectRoot: e,
				artifactRoot: o.native.artifact_root,
				nativeRoot: s.nativeRoot,
				language: n,
			},
			`Initialized Comet Native at ${s.nativeRoot}
`,
		)
	);
}
async function sd(t, e, r = process.argv.slice(2)) {
	let i = r.indexOf("--"),
		n = i < 0 ? [...r] : r.slice(0, i),
		a = i < 0 ? [] : r.slice(i),
		o = n.includes("--json"),
		...
		l;
	try {
		(Bo(n, "--json"), Bo(n, "--verbose"), (c = Tr(n, "--project-root")));
		let u = [...n, ...a],
			d = await td(c);
		l = await e(u, d);
	} catch (u) {
...
process.exitCode = await sd("init", od);
