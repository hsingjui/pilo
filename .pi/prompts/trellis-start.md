...
- **Active task status `in_progress`** → Phase 2 step 2.1. Load the step detail:
  ...
  ```
- **No active task** → do NOT ask whether to create a task. Handle the request inline this turn. Only create a Trellis task when the user explicitly asks for one.
